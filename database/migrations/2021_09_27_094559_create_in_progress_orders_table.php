...
class CreateInProgressOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('in_progress_orders', function (Blueprint $table) {
            $table->increments('id')->unsigned();
            $table->unsignedInteger('erp_user_id');
            $table->string('erp_status')->default('1');
    ...
    {
        Schema::dropIfExists('in_progress_orders');
    }
}
