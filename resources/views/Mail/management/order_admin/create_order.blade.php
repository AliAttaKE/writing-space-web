    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-12">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 mt">
                <button type="button" class="btn btn-primary float-right"> Back
                </button>
            </div>
                ...
                <div class="row my-4">
                    ...
                    <div class="col-lg-5 col-12">
                        ...
                        <div class="form-line">
                            ...
                            <input id="myDatePicker" class="flatPicker flatpickr-input active" placeholder="Please choose a date..." type="text">
                        </div>
                    </div>
{{--                    <div class="col-lg-5 col-12">--}}
{{--                        <p>Stats for September 2020</p>--}}
