...
{{--                        data-toggle="modal" data-target=".bd-example-modal-{{$data['new_order']['order']['erp_order_id']}}">--}}
{{--                    Upload--}}
{{--                </button>--}}
{{--                <div class="row">--}}
...
{{--                    <p><strong>  @if (isset($row->created_at))--}}
...
{{--    <h3 class="text-center mb-3 mt-5"> Submissions By User <i class="fa fa-user" aria-hidden="true"></i>--}}
{{--    </h3>--}}
{{--    <div class="" style="box-shadow: 0 0 1rem rgb(0 0 0 / 15%);padding:20px;border-radius:5px;">--}}
