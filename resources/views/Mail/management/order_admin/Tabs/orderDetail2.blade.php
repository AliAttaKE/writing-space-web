<!--Orders tab Start-->
<div id="tab11" class="pt-3 tab-pane fade in active show">
...
{{--                                    <input type="hidden" name="order_id" value="{{$worker->erp_order_id}}">--}}
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-danger waves-effect">Submit
                                </button>
                                <button
                                        class="close btn btn-primary" data-dismiss="modal"
...
{{--                                </button>--}}
{{--                                <button type="submit"--}}
{{--                                        class="btn btn-info waves-effect">Cancel--}}
{{--                                </button>--}}
{{--                            </div>--}}
{{--                        </form>--}}
{{--                    </div>--}}
                        ...
                        <div class="modal-content">
                            <div class="create_questions">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button"
                                            class="btn btn-info waves-effect"  data-dismiss="modal" >Cancel
                                    </button>
                                </div>
                            </div>
                        </div>
...
{{--                            </tr>--}}
{{--                            <tr>--}}
{{--                                <td>A Copy of Sources:--}}
{{--                                    {{$data['new_order']['order']['erp_copy_sources']}}--}}
{{--                                </td>--}}
{{--                            </tr>--}}
{{--                            <tr>--}}
{{--                                <td>Outline in Bullets:--}}
