        ...
        <div class="modal-content">
            <div class="create_questions">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Create Reason</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="" action="{{route('Request-reason.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="erp_comment_text">
                            <div class="erp_comment_text">
                                ...
                                <textarea name="description"  class="form-control" id="erp_comment_text" cols="30" rows="10"></textarea>
                            </div>
                        </div>
