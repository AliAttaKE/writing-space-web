    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <form id="" action="{{url('product_store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="p-5 col-md-5">
                                        <select class="form-control select2" name="duration_type" id="Quiz-type" data-placeholder="Select">
                                            ...
                                            <option {{ old('duration') == 'weeks' ? 'Selected' : '' }}  value="weeks">weeks</option>
                                            <option {{ old('duration') == 'months' ? 'Selected' : '' }}  value="months"> months</option>
                                            <option {{ old('duration') == 'years' ? 'Selected' : '' }}  value="years">years</option>
