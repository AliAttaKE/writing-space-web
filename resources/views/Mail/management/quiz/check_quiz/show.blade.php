...
{{--                                                            @foreach($ques as $data)--}}
                                                        Q {{$i}} :  {!! $questions['erp_question_text'] !!}
{{--                                                                @endforeach--}}
                                                    </div>
                                                </div>
                        ...
                        <div class="card">
                            <div class="header">
                                <form action="{{url('quizresult')}}" method="post">
                                    @csrf
                                    <div class="row align-items-center">

                                        <input type="hidden" name="quiz_id" value="{{$data[0]['erp_quiz_id']}}">
                                        <input type="hidden" name="quiz_answer_id" value="{{$data[0]['quiz_answer_id']}}">
                                        <input type="hidden" name="quiz_user_id" value="{{$data[0]['erp_user_id']}}">
                                        <input type="hidden" name="quiz_type" value="{{$data[0]['erp_quiz_type']}}">
{{--                                        @dd($data[0]['user_quiz_status'])--}}
                                            <div class="col">
                                                <select class="form-control select2" name="result" id="Quiz-type" data-placeholder="Select">
                                                    <option {{$data[0]['user_quiz_status'] == 1 ? 'selected' : ''}} value="1">Pass</option>
                                                    <option {{$data[0]['user_quiz_status'] == 0 ? 'selected' : ''}} value="0">fail</option>
                                                </select>
                                            </div>
