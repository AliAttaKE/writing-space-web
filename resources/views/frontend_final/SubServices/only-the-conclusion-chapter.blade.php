...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Conclusion Chapters Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Finalizing Your Thesis? <br> <span
                            class="subhead-subhead yellow-text">Craft Conclusions That Leave A Lasting Academic Legacy!</span></h2>
                </div>
                <p class="custom-description text-white">Facing the final stretch of your thesis or dissertation, are
                    you struggling to craft a Conclusion Chapter that effectively encapsulates your research journey and
                    its broader implications? The Conclusion Chapter is crucial, serving as the capstone of your
                    academic work. It must not only summarize the key findings but also provide insightful
                    interpretations, reflect on the research process, and articulate the significance of the study
                    within the academic field. Creating a powerful, impactful conclusion that leaves a lasting
                    impression on readers and establishes a legacy in your academic discipline can be a formidable
                    challenge.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Finish Strong - <br> <span class="subhead-subhead yellow-text">
                    Conclusions That Synthesize and Impress!</span></h2>
                </div>
                <p class="custom-description text-white">End your thesis on a high and produce conclusive chapters that
                    elevate your work with our unparalleled service. Our expertly crafted Conclusions delve deeply into
                    your research findings, providing insightful interpretations and reflecting on your entire research
                    journey. We ensure your closing chapter lays out the profound implications of your work, elevating
                    your thesis or dissertation to new heights. Trust us to help you conclude your academic endeavor
                    with a powerful, lasting legacy in your field, crafting a final chapter that resonates with clarity,
                    depth, and impact.
                </p>
            </div>
