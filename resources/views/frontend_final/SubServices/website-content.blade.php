...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Website Content Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Web Content Falling Flat? <br> <span
                            class="subhead-subhead yellow-text">Spark Engagement and Convert Clicks to Customers!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">Are you looking to transform your online presence but find it
                    challenging to create engaging and effective website content? In today’s digital age, standing out
                    online requires more than just a functional website; it demands content that captures and retains
                    the attention of your audience, converting visitors into loyal customers. Many businesses struggle
                    to find the right words that resonate with their brand identity and market positioning, highlighting
                    the need for professional content writing services that can articulate their vision and drive online
                    engagement.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Turn Clicks into Customers – <br> <span
                            class="subhead-subhead yellow-text">Content That Drives Action!</span></h2>
                </div>
                <p class="custom-description text-white">Transform your online presence with our premier content writing
                    service, where creativity meets efficiency. Elevate your website with our engaging content creation,
                    which includes effective website content writing and high-quality blog post writing services
                    tailored for businesses aspiring to stand out. At the heart of our offering are professional website
                    content writing packages designed to convert visitors into loyal customers. Seize the opportunity to
                    captivate your audience and convert leads to customers; invest in custom written website content now
                    and begin your journey towards establishing a dominant online presence.
                </p>
            </div>
