...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Business Plan Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Daunted by Business Plans? <br> <span
                            class="subhead-subhead yellow-text">Navigate from Coursework to Market Success!</span></h2>
                </div>
                <p class="custom-description text-white">Are you a student faced with the challenge of creating a
                    business plan for your academic coursework, struggling to integrate market analysis, business growth
                    strategies, and financial projections into a cohesive document? Crafting a realistic and
                    comprehensive business plan is crucial for your academic success, yet it can be daunting to align
                    these elements effectively within the academic framework, highlighting the need for a tailored
                    solution that can seamlessly bridge theoretical learning with practical application.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Business Planning Excellence – <br> <span
                            class="subhead-subhead yellow-text">Your Pathway to Domination!</span></h2>
                </div>
                <p class="custom-description text-white">Achieve excellence with our custom model papers and craft the
                    ultimate business plan. Tailored for students, our service provides a comprehensive model that
                    covers market analysis strategies, business growth planning, and financial forecasting, all within
                    the academic context. Ideal for students seeking to excel in their coursework and simulate
                    real-world business scenarios, our custom-written business plans serve as a robust template. Our
                    custom written papers offer a structured approach to developing your business plan, ensuring you not
                    only meet but exceed academic requirements while gaining practical insights into the business
                    planning process.
                </p>
            </div>
