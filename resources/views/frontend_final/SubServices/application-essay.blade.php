...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Application Essay Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Difficulties in Showcasing Your Journey? <br> <span
                            class="subhead-subhead yellow-text">Craft an Application Essay That Stands Out!</span></h2>
                </div>
                <p class="custom-description text-white">Are you striving to make an indelible mark on the admissions
                    committee, but struggling with how to articulate your unique journey, ambitions, and dreams in an
                    application essay? Crafting an essay that effectively communicates your personal background,
                    academic achievements, and extracurricular endeavors is a daunting task. It requires a delicate
                    balance of storytelling and strategic alignment with the objectives of your desired program. Many
                    applicants find it challenging to highlight their strengths and career aspirations in a way that not
                    only stands out but also authentically represents them, underscoring the need for a custom-written
                    solution that can make their application shine.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Turn Dreams into Reality with Our - <br> <span
                            class="subhead-subhead yellow-text">Winning Essay Formula!</span></h2>
                </div>
                <p class="custom-description text-white">Transform your future with our standout application essay
                    services, where we specialize in crafting compelling narratives that resonate with your unique
                    journey and dreams. Our process begins by meticulously mapping out the key elements of your reality,
                    including your personal background, academic achievements, and extracurricular endeavors. We then
                    skillfully weave these elements into a cohesive narrative, highlighting your strengths and aligning
                    them with the goals of your dream program. Our objective is to eloquently express your career
                    aspirations and reasons for choosing your desired path, ensuring your application not only stands
                    out but also authentically represents you. Let us help you make an unforgettable impression on the
                    admissions committee, propelling you toward your academic and career goals with a tailored,
                    impactful essay.
                </p>
            </div>
