...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Dissertation or Thesis Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Overawed by Your Dissertation? <br> <span
                            class="subhead-subhead yellow-text">Achieve Distinction with Expert-Crafted Work!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">Are you embarking on the challenging journey of crafting a
                    comprehensive dissertation or a pivotal thesis, feeling the weight of academic expectations on your
                    shoulders? The process of developing these significant academic works requires not only a deep dive
                    into your subject matter but also the ability to present critical insights and in-depth analysis
                    that meet the highest academic standards. Many students find this phase of their academic journey
                    daunting, as it involves extensive research, meticulous planning, and precise execution, all while
                    striving to contribute meaningfully to their field of study.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Master Your Field with A Thesis That - <br> <span
                            class="subhead-subhead yellow-text">Sets You Apart!</span></h2>
                </div>
                <p class="custom-description text-white">Cross the finishing line in your academic voyage with our
                    custom-written dissertations and theses, meticulously crafted to align with your unique requirements
                    and academic goals. Our team of dedicated experts is here to guide you toward mastering your field,
                    offering support in delving deep into your subject matter. We ensure your dissertation or thesis not
                    only adheres to the highest academic standards but also enriches your research with critical
                    insights and in-depth analysis. Embark on your path to success with us today, and let us help you
                    cross the finish line with confidence and distinction, transforming your academic challenges into a
                    triumphant milestone that sets you apart.
                </p>
            </div>
