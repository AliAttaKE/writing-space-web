...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Literature Review Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Lost in Literature Reviews? <br> <span
                            class="subhead-subhead yellow-text">Gain Depth and Perspective with Expert Guidance!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">As a university student embarking on a thesis or dissertation,
                    do you find the task of composing a comprehensive literature review daunting? The literature review
                    is a cornerstone of academic research, requiring the identification, critical examination, and
                    synthesis of relevant academic literature to establish a solid foundation for your study. Crafting a
                    literature review that provides deep insights and a comprehensive understanding of the research
                    landscape can be a complex and time-consuming task, especially for students aiming for top grades
                    while managing a busy academic schedule.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Comprehensive Insight – <br> <span
                            class="subhead-subhead yellow-text">Literature Reviews That Cover Every Angle!</span></h2>
                </div>
                <p class="custom-description text-white">Unravel academic richness and showcase your literature reviews
                    that enlighten with our tailored literature review service. Our custom-written literature reviews
                    are crafted meticulously to align with your unique research needs, providing the deep and
                    comprehensive insights and background essential for the success of your thesis or dissertation. Our
                    service helps you pave the way to academic excellence, enriching your research with a critical
                    examination and synthesis of the relevant academic literature. Embark on your scholarly quest with
                    confidence, supported by a robust foundation of well-integrated research findings. Perfect for busy
                    university students aiming for top grades, our service ensures you have the best support at every
                    step of your academic adventure.
                </p>
            </div>
