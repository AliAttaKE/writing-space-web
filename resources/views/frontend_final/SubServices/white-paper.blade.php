...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">White Paper Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Lost in Complexity? <br> <span
                            class="subhead-subhead yellow-text">Discover Clarity and Influence with Our White Papers!</span></h2>
                </div>
                <p class="custom-description text-white">Are you navigating through a sea of complexity, searching for
                    clear and authoritative guidance to resolve intricate issues? In the realm of professional and
                    academic research, distinguishing oneself as a thought leader or decision-maker often involves the
                    ability to strategize and implement innovative solutions. However, the challenge lies in accessing
                    well-researched and persuasive white papers that not only analyze problems comprehensively but also
                    present actionable solutions. The need for such high-quality white papers is paramount, especially
                    for those looking to influence and enact change in their respective fields.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Expertise in Every Line – <br> <span
                            class="subhead-subhead yellow-text">White Papers That Define Success!</span></h2>
                </div>
                <p class="custom-description text-white">Dive into the realm of clarity and success with our definitive
                    white papers, where every line is expertly crafted to be your beacon in the sea of complexity. Each
                    document is structured to provide a comprehensive introduction to the topic at hand, followed by
                    detailed problem analysis and the presentation of innovative solutions backed by meticulous
                    research. Ideal for thought leaders and decision-makers, our white papers empower you to strategize
                    decisions and implement groundbreaking solutions with confidence. They are designed for those aiming
                    to influence and enact change, serving as a critical step towards informed action. Explore our
                    collection to gain access to the keys for unlocking effective solutions, with documents available
                    online for immediate acquisition.
                </p>
            </div>
