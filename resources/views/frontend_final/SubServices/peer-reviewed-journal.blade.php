...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Peer Review Journal Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Battling with Academic Publishing? <br> <span
                            class="subhead-subhead yellow-text">Break Through to Scholarly Recognition!</span></h2>
                </div>
                <p class="custom-description text-white">Are you struggling with the high demands of academic
                    publishing, especially in peer-reviewed journals? Meeting the stringent standards for scholarly
                    content, critical analysis, and coherent argumentation required by these journals can seem like a
                    formidable task. You may find it challenging to produce papers that meet these rigorous criteria
                    while juggling a hectic academic schedule. This struggle can hinder your academic progress,
                    highlighting the need for a resource that not only aids in crafting high-quality research papers but
                    also enhances your understanding of the subject and supports efficient time management, propelling
                    you towards academic excellence. </p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Effortlessly Navigate the Path to - <br> <span
                            class="subhead-subhead yellow-text">Academic Publication!</span></h2>
                </div>
                <p class="custom-description text-white">Step into academic success and easily navigate your path to an
                    academic publication. Our custom-written academic papers are designed for the rigorous standards of
                    peer-reviewed journals. Our service offers you the support of scholarly experts dedicated to
                    advancing your success, delivering articles that not only boost your grades but also deepen your
                    understanding. Each paper we provide undergoes a strict review process, ensuring alignment with the
                    high scholarly criteria, featuring well-researched content, critical analysis, and coherent
                    argumentation. Tailored to your unique requirements, our service is your academic ally, helping you
                    to navigate the complexities of peer-reviewed journal submissions. Overcome the challenges of a
                    packed schedule and elevate your academic standing with our peer-reviewed journal-quality papers,
                    crafted to redefine your educational journey.
                </p>
            </div>
