...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">PowerPoint Presentation Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Need Impactful Presentations? <br> <span
                            class="subhead-subhead yellow-text">Transform Slides into Captivating Stories!</span></h2>
                </div>
                <p class="custom-description text-white">Are you struggling to create PowerPoint presentations that not
                    only captivate but also persuade your audience? Crafting an effective presentation requires more
                    than just assembling slides; it demands a combination of engaging design, compelling content, and
                    the ability to convey complex ideas clearly and persuasively. Whether for academic purposes or
                    critical business proposals, the challenge lies in transforming your ideas into impactful visuals
                    that resonate with viewers and leave a lasting impression. This need underscores the importance of a
                    solution that elevates your presentation skills and helps reveal your full potential.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Captivate and Convince – <br> <span class="subhead-subhead yellow-text">PowerPoint Presentations That Perform!</span></h2>
                </div>
                <p class="custom-description text-white">Discover the secret to mesmerizing and persuasive PowerPoint
                    presentations with our top-tier digital products. Designed to captivate and convince, our PowerPoint
                    creations go beyond mere slides; they unlock potential and performance. Catering to both academic
                    and business needs, our presentations are meticulously crafted to ensure you communicate your ideas
                    effectively, transforming them into impactful, memorable visuals. Elevate your presentation game
                    with our expertly designed slides, and watch as opportunities unfold, enhancing your ability to
                    leave a lasting impression and achieve success in your academic or professional endeavors.
                </p>
            </div>
