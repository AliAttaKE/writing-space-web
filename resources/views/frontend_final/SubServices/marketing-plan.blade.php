...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Marketing Plan Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Struggle with Marketing Plans? <br> <span
                            class="subhead-subhead yellow-text">Navigate the Maze to Strategic Success!</span></h2>
                </div>
                <p class="custom-description text-white">Are you struggling to navigate the complex world of marketing
                    strategies and execution plans? Crafting a comprehensive marketing plan is crucial for students and
                    professionals aiming to understand market dynamics, identify competitive advantages, and effectively
                    position their business or academic project. The process involves not only the development of smart
                    objectives and marketing strategies but also a thorough analysis of market trends, competitive
                    landscapes, and budget allocations. The absence of a structured and detailed approach can lead to
                    ineffective marketing efforts, undermining the potential for academic and business success and
                    highlighting the need for a guide that demystifies the marketing planning process.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Instantly Dominate Your Settings with Our - <br> <span
                            class="subhead-subhead yellow-text">Winning Plans!</span></h2>
                </div>
                <p class="custom-description text-white">Elevate your strategic marketing approach to instantly dominate
                    with our expertly designed Marketing Plan. Begin your journey to marketing mastery with an engaging
                    introduction that sets the stage for a transformative strategy. Our guide leads you through the
                    creation of effective marketing plans, offering smart objectives marketing strategy tips, and
                    comprehensive market analysis information. Delve deeper with detailed competitor analysis strategy
                    tutorials, and conclude with a strategic overview that integrates all insights, facilitating
                    successful marketing budget planning. Our digital academic paper is meticulously structured,
                    providing a clear path from theoretical understanding to practical application, making it an
                    indispensable resource for anyone looking to improve their market position or refine marketing
                    tactics. This comprehensive guide is your key to unlocking outstanding results in marketing strategy
                    and execution.
                </p>
            </div>
