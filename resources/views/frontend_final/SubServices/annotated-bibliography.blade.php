...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Annotated Bibliography Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Drowning in Sources for Annotated Bibliographies? <br> <span
                            class="subhead-subhead yellow-text">Streamline Your Research Success!</span></h2>
                </div>
                <p class="custom-description text-white">As a university student, are you overwhelmed by the relentless
                    onslaught of assignments and the ever-present pressure of time constraints? Navigating the academic
                    landscape requires more than just completing tasks; it demands a deep understanding and critical
                    evaluation of a myriad of sources. This rigorous process is pivotal in crafting annotated
                    bibliographies that not only summarize but also critically analyze and reflect on the relevance and
                    impact of each source on your research topic. The challenge to efficiently integrate these elements
                    can hinder your academic progress, necessitating a specialized solution that streamlines your
                    research process and enhances your understanding and analytical skills.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Elevate Your Research with Our <br> <span
                            class="subhead-subhead yellow-text">Expert Annotated Bibliographies!</span></h2>
                </div>
                <p class="custom-description text-white">Step beyond the ordinary and transform your academic research
                    with our custom-written annotated bibliographies, designed to elevate your research endeavor and
                    support your unique academic needs. Our service specializes in crafting annotated bibliographies
                    that not only list sources but also provide a comprehensive evaluation, offering insights into their
                    significance and relevance to your research topic. Each entry includes a summary of the content, an
                    analysis of its value, and a reflection on its implications for your work, structured to guide your
                    research journey effectively. Our expertly curated bibliographies aim to elevate your academic
                    performance, ensuring a seamless and enlightening experience that paves the way for scholastic
                    success. Join us in a realm where excellence and personalization converge, crafting the foundation
                    of your academic triumph.
                </p>
            </div>
