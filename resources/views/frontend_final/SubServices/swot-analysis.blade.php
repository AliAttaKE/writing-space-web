...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">SWOT Analysis Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Overwhelmed by Swot Assignments? <br> <span
                            class="subhead-subhead yellow-text">Your Strategic Skills Deserve to Shine!</span></h2>
                </div>
                <p class="custom-description text-white">Are you feeling swamped by the daunting task of crafting SWOT
                    analyses for your university assignments? As a student, you're expected to demonstrate a deep
                    understanding of strategic concepts, dissecting strengths, weaknesses, opportunities, and threats
                    with precision. With deadlines fast approaching, you may find it challenging to produce analyses
                    that reflect your true strategic acumen, hindering your academic distinction. The pressure to
                    deliver insightful and personalized SWOT analyses is immense, highlighting the need for a solution
                    that aligns with your specific educational demands and enhances your strategic evaluation skills.
                </p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Master Market Strategy – <br> <span
                            class="subhead-subhead yellow-text">Swot Analyses That Deliver Insights!</span></h2>
                </div>
                <p class="custom-description text-white">Elevate your grades and insights with our custom SWOT Analysis
                    service, tailored for the ambitious university propelling towards market mastery. Our custom-written
                    SWOT Analyses integrate your individual requirements with our expertise, enabling you to navigate
                    your academic journey with confidence. This service not only transforms your challenges into
                    opportunities for success but also includes a clear structure for each analysis, starting with an
                    introduction, followed by in-depth examination of strengths, weaknesses, opportunities, and threats,
                    and concluding with actionable strategic recommendations, ensuring each submission is a testament to
                    your strategic foresight and academic excellence.
                </p>
            </div>
