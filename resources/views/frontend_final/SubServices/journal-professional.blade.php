...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Journal Professional Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Overwhelmed by Academic Research? <br> <span
                            class="subhead-subhead yellow-text">Access and Decode Insights Effortlessly!</span></h2>
                </div>
                <p class="custom-description text-white">Are you seeking to navigate the vast and dynamic landscape of
                    academic and professional knowledge, yet find it overwhelming to access and assimilate the latest
                    groundbreaking discoveries and cutting-edge research? In today’s fast-paced academic and
                    professional environments, staying informed with the most current and comprehensive insights can be
                    a daunting task. Many struggle to bridge the gap between raw data and actionable discovery, yearning
                    for a resource that not only provides access to these intellectual treasures but also distills
                    complex information into compelling, narrative-driven insights, enhancing understanding and
                    application in various fields.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">From Data to Discovery – <br> <span
                            class="subhead-subhead yellow-text">Journal Articles That Matter!</span></h2>
                </div>
                <p class="custom-description text-white">Unleash the power of data and knowledge with Journal
                    Professional, the zenith of academic innovation and discovery. Our digital platform is a curated
                    collection, designed to transform complex information into accessible, narrative-driven insights,
                    bridging the gap from data to discovery. Dive deep into a sea of wisdom with our suite of articles,
                    each a treasure trove of the latest groundbreaking discoveries and cutting-edge research. Journal
                    Professional is your gateway to mastering the intricacies of various fields, offering articles that
                    not only inform but also inspire. Embark on an intellectual journey with us and navigate through the
                    vast landscapes of knowledge and academic excellence. With Journal Professional, step into a future
                    where limitless knowledge and professional growth are just a click away, ready to empower your
                    journey on the shoulders of giants.
                </p>
            </div>
