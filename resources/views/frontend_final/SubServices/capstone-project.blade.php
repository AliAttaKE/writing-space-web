...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Capstone Project Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Capstone Project Overwhelming? <br> <span
                            class="subhead-subhead yellow-text">Achieve Academic Brilliance with Tailored Guidance!</span></h2>
                </div>
                <p class="custom-description text-white">Are you an ambitious university student aiming for academic
                    excellence, yet facing challenges in completing your capstone project? Capstone projects represent a
                    pinnacle of academic effort, requiring a synthesis of research, innovation, and practical
                    application tailored to your field of study. Many students find it daunting to conceptualize and
                    execute a project that not only meets their academic requirements but also pushes the boundaries of
                    their subject area, necessitating a partner in academic achievement who can help translate their
                    academic vision into a tangible and impactful reality.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Excel In Academics – <br> <span class="subhead-subhead yellow-text">Capstone Projects That Impress and Influence!</span></h2>
                </div>
                <p class="custom-description text-white">Showcase your true potential with our custom-written capstone
                    projects, tailored for the university student determined to achieve academic excellence. Our service
                    is designed to pave the path to success, empowering you to surpass academic challenges with ease. As
                    your dedicated partner, we commit to crafting capstone projects that not only meet but exceed your
                    unique needs and expectations. From comprehensive research papers to innovative business plans, or
                    groundbreaking software products, our expert team is equipped to transform your academic vision into
                    reality. Let us guide you on this journey towards remarkable accomplishments, ensuring you excel in
                    academics.
                </p>
            </div>
