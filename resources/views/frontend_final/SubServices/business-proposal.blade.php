...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Business Proposal Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Confused by Business Proposals? <br> <span
                            class="subhead-subhead yellow-text">Unlock Strategic Success with Expert Guidance!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">Are you a university student wrestling with the task of
                    creating a compelling business proposal, feeling confused by the complexity and importance of this
                    academic requirement? Crafting a business proposal involves more than just outlining a business
                    idea; it requires a detailed plan that demonstrates feasibility, market understanding, and strategic
                    insight. Students often struggle with this intricate process, finding it challenging to balance
                    academic rigor with practical business acumen, all while managing the stress of tight deadlines and
                    maintaining academic integrity.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Craft Your Next Success – <br> <span
                            class="subhead-subhead yellow-text">Business Proposals That Persuade and Prevail!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">Reveal your true potential and say goodbye to sleepless nights
                    with our premier custom-written service for crafting business proposals. Designed to meet the unique
                    needs of busy university students like you, our service is a beacon of hope in the complex task of
                    developing a business proposal. Our expert writers are adept at crafting business proposals that are
                    not only precise but also strategically sound, ensuring each piece meets your specific requirements
                    and academic standards. Dive into a world where your business proposal deadlines are met with
                    confidence, and your academic integrity is upheld. With us, achieving excellence in your business
                    proposal is not just a goal; it's a guarantee.
                </p>
            </div>
