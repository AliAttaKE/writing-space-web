...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Tailor Made Essay Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Stressed by Essay Standards? <br> <span
                            class="subhead-subhead yellow-text">Unlock Academic Excellence with Tailor-Made Solutions!
                        </span></h2>
                </div>
                <p class="custom-description text-white">Are you a busy university student grappling with the pressure
                    to achieve academic excellence, yet finding it challenging to produce essays that meet the high
                    standards required? Crafting essays that stand out in the competitive academic arena demands not
                    only a deep understanding of the subject matter but also the ability to articulate thoughts in a
                    coherent and engaging manner. Many students struggle to balance their demanding schedules with the
                    need to produce quality written work, necessitating a solution that not only delivers superior
                    quality essays but also aligns with their unique needs and challenges.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Unleash Academic Potential – <br> <span
                            class="subhead-subhead yellow-text">Essays That Impress Every Time!</span></h2>
                </div>
                <p class="custom-description text-white">Unleash your academic potential with our custom-written essays,
                    meticulously crafted to meet your unique needs and challenges. As your ultimate companion in the
                    quest for academic excellence, we offer personalized essays that serve as a secret weapon to
                    outshine in the competitive academic arena. Our service is designed to elevate your grades and free
                    up your schedule, providing a seamless solution to meeting deadlines with superior quality
                    guaranteed. Step into the future of academic success with us, where your potential knows no bounds
                    and tailor-made essays await to propel you towards your academic goals.
                </p>
            </div>
