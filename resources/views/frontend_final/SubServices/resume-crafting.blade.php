...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Resume Crafting Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Can't Stand Out with Your Resume? <br> <span
                            class="subhead-subhead yellow-text">Craft A Gateway to Your Dream Job! </span></h2>
                </div>
                <p class="custom-description text-white">Are you struggling to differentiate yourself in the competitive
                    job market, aiming to craft a resume that not only showcases your qualifications but also resonates
                    with your career ambitions? Creating a compelling resume is a critical step in unlocking job
                    opportunities, yet many find it challenging to effectively highlight their unique skills,
                    experiences, and achievements. The task of aligning one's professional profile with the job market's
                    demands requires a nuanced approach that captures the essence of one’s career journey, making it
                    essential to have a service that can tailor your resume to reflect your individual strengths and
                    aspirations.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Land Your Dream Job – <br> <span
                            class="subhead-subhead yellow-text">Resumes That Open Doors Instantly!</span></h2>
                </div>
                <p class="custom-description text-white">Unleash your potential and confidently open doors into your
                    future with our bespoke resume writing service. Designed to elevate your professional profile, our
                    service meticulously highlights your unique skills, experiences, and achievements, crafting a resume
                    that not only showcases your qualifications but also aligns with your career ambitions. Our
                    comprehensive and tailored approach ensures that your resume makes a compelling first impression,
                    captivating potential employers and opening doors to new opportunities. Let us guide you in creating
                    the perfect resume, setting the stage for you to seize your dream job.
                </p>
            </div>
