...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Book Report Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Drowning in Book Reports? <br> <span
                            class="subhead-subhead yellow-text">Discover Insights and Save Time with Custom Help!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">Are you a university student overwhelmed by the need to produce
                    detailed book reports while balancing other academic responsibilities and looming deadlines?
                    Crafting a book report that impresses professors involves more than just summarizing the text; it
                    requires deep insights, critical analysis, and the ability to express personal perspectives
                    compellingly. Many students find this task time-consuming and challenging, especially when striving
                    for academic excellence in a competitive educational environment. This creates a pressing need for a
                    service that can deliver custom-written book reports tailored to individual requirements, ensuring
                    high-quality analysis and personal reflection.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Uncover Literary Insights with Our – <br> <span
                            class="subhead-subhead yellow-text">Expert Book Reports!</span></h2>
                </div>
                <p class="custom-description text-white">Our bespoke book reports are designed to save you precious time
                    while ensuring your academic success shines brightly with literary insights. Meticulously crafted to
                    meet your unique requirements, our custom-written book reports provide deep insights, critical
                    analysis, and personal perspectives on any book, tailored to resonate with your academic goals.
                    Ideal for the busy university student aiming for perfection but pressed for time, our service is
                    committed to elevating your academic journey to new heights. Experience the convenience of
                    excellence with us and watch your grades soar as we transform your academic challenges into
                    triumphs.
                </p>
            </div>
...
<section class="bg-dark section-card-phases">
    ...
    <!--            <div class="mb-4">-->
    <!--                <a href="{{ route('customer.show.libraries') }}" class="text-decoration-none"> <!-- Link route to the paper detail page -->-->
