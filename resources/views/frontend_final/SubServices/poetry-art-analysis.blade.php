...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Poetry Art Analysis Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Struggling with Art and Poetry Analysis? <br> <span
                            class="subhead-subhead yellow-text">Unravel Layers of Meaning and Connect Deeply!</span>
                    </h2>
                </div>
                <p class="custom-description text-white">Are you navigating the academic whirlwind, seeking to deepen
                    your understanding and appreciation of poetry and art? Analyzing these forms requires a unique blend
                    of precision and creativity, as you strive to uncover the layers of meaning and connect form with
                    feeling. It's a complex task, requiring not just an eye for detail but also the ability to weave
                    together comprehensive evaluations of artistic significance. This intricate process can be
                    overwhelming, especially when attempting to transform static words and images into dynamic
                    narratives and insightful critiques.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Dive into A Sea of Words – <br> <span
                            class="subhead-subhead yellow-text">Poetry and Art Analysis That Touches Souls!</span></h2>
                </div>
                <p class="custom-description text-white">Embark on a transformative journey where precision meets
                    creativity, and knowledge knows no bounds. Dive into a Sea of Words with our custom-written academic
                    papers in poetry and art analysis. Our platform serves as a sanctuary, offering detailed analyses
                    that unravel the layers of meaning, seamless interpretations that connect form with feeling, and
                    comprehensive evaluations that gauge artistic significance. Each paper we provide is a meticulously
                    tailored masterpiece, designed to elevate your understanding and appreciation of the arts. With our
                    support, your academic pursuits will be infused with analytical genius, transforming every sentence
                    into a stroke of insight and every analysis into a pathway to deeper artistic appreciation.
                </p>
            </div>
