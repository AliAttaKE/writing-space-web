...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Case Study Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Challenged by Case Studies? <br> <span
                            class="subhead-subhead yellow-text">Unlock Insights and Solutions with Expert Analysis!</span></h2>
                </div>
                <p class="custom-description text-white">Are you confronting academic or business challenges that seem
                    insurmountable, searching for a way to uncover innovative solutions and gain unrivaled insights?
                    Crafting and analyzing case studies is a crucial method for dissecting complex scenarios,
                    identifying core problems, and developing actionable solutions. However, the process can be
                    overwhelming, requiring a deep dive into the specifics of the challenge while maintaining an
                    objective stance. The need for a meticulously designed, comprehensive case study becomes apparent,
                    one that serves not just as a document but as a blueprint for success, guiding learners and leaders
                    alike through the intricacies of problem-solving.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Analyze and Achieve – <br> <span class="subhead-subhead yellow-text">Case Studies That Drive Understanding!</span></h2>
                </div>
                <p class="custom-description text-white">Unlock the full potential of your academic challenges with our
                    groundbreaking case study writing service. Embark on an expertly crafted journey of problem-solving,
                    where each section turns the key to innovative solutions and unrivaled insights. Our case study is
                    meticulously designed to serve as a blueprint for success, featuring an executive summary that
                    provides a snapshot of the challenge and the solution, a comprehensive background that sets the
                    stage for understanding, and an actionable solution that's ready for implementation. Perfect for
                    ambitious learners and forward-thinking leaders, this case study is your gateway to transforming
                    challenges into opportunities, guiding you step by step toward achieving your goals.
                </p>
            </div>
