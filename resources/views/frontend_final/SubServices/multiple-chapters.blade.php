...
@section('content')
    ...
    <section class="bg-dark section-card-phases">
        <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
            ...
            <div class="text-container flex-grow-1 text-center position-relative">
                <h1 class="heading heading-custom-3">Multiple Chapters Details</h1>
            </div>
            ...
            <section class="row my-card mt-3 bordered-card">
                <div class="col-md-8">
                    <div class="heading-container">
                        <h2 class="heading-val head-head">Juggling Thesis Chapters? <br> <span
                                class="subhead-subhead yellow-text">Weave A Seamless Scholarly Narrative from Start to Finish!</span></h2>
                    </div>
                    <p class="custom-description text-white">Are you an ambitious university student tasked with submitting
                        a thesis or dissertation that reflects the pinnacle of academic achievement? Crafting multiple
                        chapters of a thesis or dissertation that seamlessly integrate to form a coherent, scholarly
                        narrative is a monumental task. Each chapter must not only contribute to the overarching thesis but
                        also stand out in its own right, demanding extensive research, meticulous writing, and comprehensive
                        structuring. This challenge can be overwhelming, requiring a level of precision and dedication that
                        aligns with the high standards of academic institutions and the ambitious goals of the student.</p>
                </div>
                <div class="col-md-4 text-center">
                    <img class="" src="{{ asset('fronted_final/assets/images/Group-individual.png') }}"
                        alt="Description">
                </div>

                <div class="col-md-8 pt-5">
                    <div class="heading-container">
                        <h2 class="heading-val head-head">From Introduction to Conclusion – <br> <span
                                class="subhead-subhead yellow-text">Cohesive Chapters That Captivate!</span></h2>
                    </div>
                    <p class="custom-description text-white">Build your thesis to perfection, chapter by chapter, with our
                        premier custom-writing service. Our service excels in creating meticulously researched, impeccably
                        written, and comprehensively structured academic papers that span multiple chapters, transforming
                        your specific needs into scholarly works of art. Whether it’s the literature review, methodology,
                        results, or discussion chapters, each segment we craft is a testament to your hard work and our
                        dedication to excellence. Don’t settle for less—choose the best academic ally to propel you towards
                        success, offering unparalleled support and expertise to ensure your thesis or dissertation not only
                        meets but exceeds the standards of your academic institution.
                    </p>
                </div>
                <div class="col-md-4 pt-5 text-center">
                    <img class="" src="{{ asset('fronted_final/assets/images/Groupindividual-2.png') }}"
                        alt="Description">
                </div>
    ...
    <section class="bg-dark section-card-phases">
        ...
        <!--                                <button class="btn btn-secondary my-btn" style="background-color: #007bff; border: none; min-width: 120px; margin-left: 24px;">-->
        <!--                                    {{ $paper->plagiarism }}%-->
        <!--                                </button>-->
        <!--                            </p>-->
        <!--                        </div>-->
        ...
        <div class="container my-5">
            <div class="row justify-content-center">
                ...
                <div class="d-flex justify-content-center align-items-center mt-5">
                    <a href="{{ route('customer.customerPlaceOrder') }}" class="gradient-btn border-0 text-decoration-none btn-custom-width">LEARN MORE</a>
                ...
                <div class="col-md-6 p-2">
                    <div class="bordered-card pt-4 px-4 h-310px pb-3 text-center">
                        <div class="">
                            ...
                            <h1 class="main-text text-white">Turnitin Plagiarism Reports Available</h1>
                            <p class="text-white custom-line-h">
                ...
                <div class="col-md-6 p-2">
                    <div class="bordered-card pt-4 px-4 pb-3 h-310px text-center">
                        <div class="">
                            ...
                            <p class="text-white custom-line-h">
                                Stand out with unique, <span class="gradient-text fw-bolder underline">AI-Proof</span> ,  <span class="yellow-text fw-bolder underline">Plagiarism-Free</span>Papers, ensuring your academic
                                integrity
                                stays
                                intact
                            </p>
    ...
    <section class="bg-dark section-card-phases">
                ...
                <div class="">
                    <div class="heading-container">
                        <h2 class="heading-val head-head">Skyrocket <span
                                class="ggradient-purple fs-2 text underline">grades</span> with expert-
        ...
        <div class="container-lg my-4 px-5 plagiarism-custom-1">
            <section class="section-skepticism my-card mt-5">
                ...
                <div class="image-container">
                    <img class="" src="{{ asset('fronted_final/assets/images/OBJECTS-2.png') }}"
                        alt="Description">
                </div>
    ...
    <section class="bg-dark section-card-phases pt-0">
                    ...
                    <div class="accordion accordion-flush" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseNine" class="accordion-collapse collapse"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes, our customer support is available 24/7 to answer any questions and assist with any
                                    issues you may encounter during the order process.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwelve" class="accordion-collapse collapse"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes, if you have previously worked with a writer whose work you were satisfied with, you
                                    can request them for your new order, subject to their availability.
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-lg my-4 px-5 d-flex justify-content-center">
            <section
                class="section-skepticism my-card individual-last-card mt-5 d-flex justify-content-center flex-column">
