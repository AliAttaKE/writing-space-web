...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Admission Essay Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Stressed About Your Admission Essay? <br> <span
                            class="subhead-subhead yellow-text">Make Your Unique Story Shine!</span></h2>
                </div>
                <p class="custom-description text-white">Facing the daunting task of crafting an admission essay that
                    stands out? The journey to your dream college hinges on an essay that perfectly balances personal
                    authenticity with a compelling narrative, showcasing your unique identity and aspirations. Many
                    students find it challenging to translate their experiences and thoughts into an essay that not only
                    captures their essence but also resonates with admissions committees. The need for a custom-written
                    model paper that serves as a benchmark for excellence is evident, providing a solution that elevates
                    your essay from the ordinary to the extraordinary.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Effortlessly Stand Out -<br> <span
                            class="subhead-subhead yellow-text">Personalized Essays for College Success!</span></h2>
                </div>
                <p class="custom-description text-white">Stand out to open the door to your dream college with our
                    custom-written model admission essays. We provide personalized, exceptional essays that serve as a
                    blueprint for success, guiding you through the nuances of crafting a standout narrative. Our service
                    includes developing compelling introductions, weaving a coherent story throughout, and concluding
                    with impactful reflections that highlight your individuality. Each model paper is meticulously
                    crafted to reflect your unique story and academic aspirations, serving as a powerful tool in
                    capturing the admissions committee's attention. Invest in our custom admission essay service to
                    transform your application journey into a compelling narrative that paves the way to your
                    educational future.
                </p>
            </div>
