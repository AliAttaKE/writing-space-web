        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Struggling to Craft Standout Term Papers? <br> <span
                            class="subhead-subhead yellow-text">Elevate Your Academic Narrative!</span></h2>
                </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Boost Grades Instantly with Our  <br> <span
                            class="subhead-subhead yellow-text">Expert Term Paper Solutions!</span></h2>
                </div>
