...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Research Proposal Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Stuck on Your Proposal? <br> <span
                            class="subhead-subhead yellow-text">Pave Your Path to Academic Success with Groundbreaking Ideas!</span></h2>
                </div>
                <p class="custom-description text-white">Are you endeavoring to push open the door to academic
                    excellence, but finding it challenging to articulate a research proposal that serves as a blueprint
                    for your success? Crafting a research proposal that stands out requires more than presenting a mere
                    idea; it demands a detailed plan that encompasses cutting-edge methodology and critical engagement
                    with existing literature. The challenge lies in creating a document that not only guides your
                    academic journey but also has the potential to revolutionize it, bridging the gap between your
                    current knowledge and your academic aspirations.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Lay the Groundwork – <br> <span
                            class="subhead-subhead yellow-text">Research Proposals That Set the Stage for Success!</span></h2>
                </div>
                <p class="custom-description text-white">Propel your project towards success and develop research
                    proposals that win approval. Use our premier custom-written academic services, specifically designed
                    for crafting impactful research proposals. Tailored to your unique specifications, our research
                    proposals are crafted to be more than just documents; they are blueprints to success. Envision a
                    world where your research proposal provides a detailed plan, meticulously crafted with attention to
                    detail, incorporating cutting-edge methodology, and critically engaging with existing literature.
                    With our service, we don’t just aim to fill gaps in knowledge; we strive to bridge you to your
                    academic aspirations, transforming your potential into unparalleled achievements. Let’s embark on
                    this journey together, shaping your future with a very well-researched and expertly written
                    proposal.
                </p>
            </div>
