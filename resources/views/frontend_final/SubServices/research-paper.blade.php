...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Reaserch Paper Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Overwhelmed by Research Papers? <br> <span
                            class="subhead-subhead yellow-text">Find Clarity and Scholarly Success Here!</span></h2>
                </div>
                <p class="custom-description text-white">Are you a university student faced with the daunting task of
                    producing a high-caliber research paper, yet struggling to find the time and resources to craft a
                    document rich in analysis, interpretation, and scholarly argument? The process of creating a
                    research paper that meets academic standards can be overwhelming, involving extensive research,
                    critical thinking, and detailed writing, all while managing other academic and personal
                    responsibilities. This challenge often leads to sleepless nights, prolonged hours in the library,
                    and the constant stress of looming deadlines, highlighting the need for a service that can provide
                    custom-written research papers tailored to individual specifications and academic goals.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Discover the Secret to Stellar - <br> <span
                            class="subhead-subhead yellow-text">Research Papers Every Time!</span></h2>
                </div>
                <p class="custom-description text-white">Unlock the key to high-quality research papers, specifically
                    tailored for busy university students like you. Our service ensures you can hand in a perfectly
                    crafted research paper, abundant in analysis, interpretation, and scholarly argument, without
                    sacrificing your precious time. With our expert team of writers, you can say goodbye to sleepless
                    nights, endless library hours, and deadline stress. We are committed to transforming your academic
                    challenges into a narrative of success, with each research paper being a meticulously aligned
                    masterpiece of knowledge to your unique specifications. Elevate your academic journey today and
                    enjoy the peace of mind that comes with knowing your academic future is in trusted hands.
                </p>
            </div>
