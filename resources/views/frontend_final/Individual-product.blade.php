...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">Term Paper Details</h1>
        </div>
        ...
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Struggling to craft standout term papers? <span class="subhead-subhead yellow-text">Elevate your academic narrative!</span></h2>
                </div>
                <p class="custom-description text-white">Are you grappling with the challenge of producing term
                    papers that resonate with academic excellence? Achieving distinction in your term paper requires
                    more than just thorough research; it demands a narrative that is compelling, evidence-backed,
                    and scholarly insightful. The task becomes even more daunting when faced with the necessity to
                    sift through and integrate only the most pertinent and authoritative sources. This intricate
                    process can significantly impede your quest for top grades, as you need a paper that not only
                    meets academic standards but also resonates with scholarly insight, demanding a solution that
                    transcends ordinary writing services to offer a masterpiece tailored to your educational
                    journey.</p>
            </div>
            ...
            <div class="col-md-8 pt-5">
                <div class="heading-container">
                    <h2 class="heading-val head-head">Boost Grades Instantly with Our <span class="subhead-subhead yellow-text">Expert Term Paper Solutions!</span></h2>
                </div>
                <p class="custom-description text-white">To boost your grades academic journey beyond the ordinary,
                    we offer custom term papers that guarantee A+ grades. Our service provides a structured academic
                    masterpiece, starting with a compelling introduction that sets the stage, followed by a body of
                    meticulously presented evidence-backed arguments, and ending with a conclusion that provides
                    deep scholarly insights. Tailored to your specific needs, our term papers adhere to strict
                    research criteria, ensuring that each source substantiates your argument effectively. Our aim is
                    to not only enhance your grades but also to enrich your academic experience, presenting a clear,
                    concise, and persuasive narrative throughout your term paper.
                </p>
            </div>
...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        <img src="assets/images/heart-line 1.png" alt="heart-line 1" class="heartbeat-line start">
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading text-white fw-bold">Results in Library</h1>
            <div class="position-absolute sub-text3">
                <span class="main-text text-purple">of Sample Papers
                </span>
            </div>
        </div>
        <img src="assets/images/heart-line 2.png" alt="heart-line 2" class="heartbeat-line end">
    ...
    <div class="text-container flex-grow-1 text-center my-4">
    ...
    <div class="heading-indi d-flex justify-content-center mt-5">
        <h4 class="heading text-white text-center">Base Your Trust on <span class="text-purple fw-bold">Verifiable</span>
            Outcomes!</h4>
    </div>
</section>
            ...
            <div class="col-12 col-md-10">
                <div class="accordion accordion-flush" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                Can I really trust your essays to bypass Turnitin’s plagiarism
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                Will the essays evade Turnitin’s AI detection as well?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                How can I be sure of the quality before submitting to my university?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                Can you handle essays on any subject and academic level?
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample" style="">
                            <div class="accordion-body">
