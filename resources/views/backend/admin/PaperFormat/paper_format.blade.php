    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 fs-color-white custom-fs-23">Paper Format</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Paper Format Order</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <!--    </div>-->
                                    <!--</th>-->
                                    <th class="min-w-80px fw_800 pb-8">Paper Format</th>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content badge-custom-bg">
            <div class="modal-header">
                <h5 class="modal-title fs-color-white custom-fs-23" id="exampleModalLabel">Paper Format</h5>
                <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                    <span class="required fs-color-white custom-fs-13">Paper Format</span>
                ...
                <input type="text" class="form-control form-control-lg form-control-solid titlename btn-dark-primary" 
                        id="title"  
                        name="title" 
                        placeholder="Paper Format..." 
                        value="" />
                <!--end::Input-->
            </div>
            <div class="modal-footer">
                
                <button type="button" class="btn badge-custom-bg-2 formatclick">Save</button>
            </div>
        </div>
        </form>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content badge-custom-bg">
            ...
            <div class="modal-body">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg form-control-solid titleset btn-dark-primary" name="title" placeholder="Paper Format" value="" />
                <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid btn-dark-primary" name="titleid" placeholder="Paper Format" value="" />
                <!--end::Input-->
...
$(document).ready(function (){
        $('.formatclick').on('click', function (){
            ...
            $.ajax({
                url: '{{ url("admin/paper_format/store") }}',
                type: 'POST',
