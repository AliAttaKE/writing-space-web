                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0 text-color">File Management  - Files</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                {{-- <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-muted">File Management</li>
                                    <!--end::Item-->
                                </ul> --}}
                                <!--end::Breadcrumb-->
                            </div>
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            <!--begin::Card-->
                            <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10 sketchy-1">
                                <!--begin::Card header-->
                                <div class="card-header pt-10">
                                    <div class="d-flex align-items-center">
                                        <!--begin::Icon-->
                                        <div class="symbol symbol-circle me-5">
                                            <div class="symbol-label bg-transparent text-primary border border-secondary border-dashed back-color">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-muted fw-bold">
                                                ...
                                                <a class="fs-color-yellow" href="{{ url('/admin/folders/show') }}">File Management</a>
                                                <span class="mx-3">|</span>{{ $totalfiles }}
                                                <span class="mx-3">|</span>{{ $folderCount }} items
                                            </div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                            ...
                            <div class="card card-flush mb-5">
                                ...
                                <div class="card-header pt-8">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                            ...
                                            <!--begin::Export-->
                                            <a href="{{ route('admin.folders.store') }}" type="button" class="btn btn-flex btn-light-primary me-3 badge-custom-bg" id="kt_file_manager_new_folder">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Folder path-->
                                        <div class="badge badge-lg badge-light-primary badge-custom-bg">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <i class="ki-duotone ki-abstract-32 fs-2x text-primary me-3 text-color">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i>
                                                <a class="text-color" href="#">Writing Space</a>
                                                <i class="ki-duotone ki-right fs-2x text-primary mx-1 text-color"></i>
                                               
                                                <a class="text-color" href="#">Folder</a>
                                            </div>
                                        </div>
                                        <!--end::Folder path-->
                                        <!--begin::Folder Stats-->
                                    ...
                                    <table id="kt_file_manager_list" data-kt-filemanager-table="files" class="table align-middle table-row-dashed fs-6 gy-5">
                                        <thead>
                                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 text-color">
                                                ...
                                                <th class="min-w-250px">Order Id</th>
                                        ...
                                        <tbody class="fw-semibold text-gray-600 text-color">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="icon-wrapper"><i class="ki-duotone ki-folder fs-color-theme fs-2x me-4"><span class="path1"></span><span class="path2"></span></i></span>
                                                        <a class="fs-color-yellow" href="{{ route('admin.folders.view', ['id' => $f->id]) }}" class="text-gray-800 text-hover-primary">{{ $f->name }}</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="" data-kt-filemanager-table="action_dropdown">
                                                    <div class="d-flex">
                                                        ...
                                                        <!--begin::More-->
                                                        <div class="ms-2">
                                                            <button type="button" class="btn btn-sm btn-icon badge-custom-bg" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4 badge-custom-bg" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="{{ route('admin.folders.download', ['id' => $f->id]) }}" class="menu-link px-3 text-white">Download File</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header pt-8">
                                        <div class="card-title">
                                            <!--begin::Search-->
                                            <div class="d-flex align-items-center position-relative my-1">
                                                <i class="ki-duotone ki-magnifier fs-1 position-absolute ms-6 text-color"><span class="path1"></span><span class="path2"></span></i> <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search">
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                                ...
                                                <!--begin::Export-->
                                                <a href="{{ route('admin.folders.store') }}" class="btn btn-flex btn-light-primary me-3" id="kt_file_manager_new_folder">
                                                    <i class="ki-duotone ki-add-folder fs-2"><span class="path1"></span><span class="path2"></span></i> New Folder
                                                </a>
                                                <!--end::Export-->
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4 badge-custom-bg" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 text-color">Download File</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
