    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 fs-color-white custom-fs-23">Subjects</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Subjects Order</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content badge-custom-bg">
            <div class="modal-header">
                <h5 class="modal-title fs-color-white custom-fs-23" id="exampleModalLabel">Subjects</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                    <span class="required fs-color-white custom-fs-13">Subjects</span>
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg btn-dark-primary form-control-solid titlename"  name="title" placeholder="Subjects" value="" />
                <!--end::Input-->
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content badge-custom-bg">
            ...
            <div class="modal-body">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg btn-dark-primary form-control-solid titleset" name="title" placeholder="Subjects" value="Subjects" />
                <input type="hidden" class="form-control form-control-lg btn-dark-primary form-control-solid titlesetid" name="titleid" placeholder="Subjects" value="Subjects" />
                <!--end::Input-->
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.subjects.destroy', ['id' => ':id']) }}".replace(':id', id),
