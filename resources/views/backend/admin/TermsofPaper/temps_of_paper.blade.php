    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 fs-color-white custom-fs-23">Paper Terms</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Paper Terms Order</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <!--    </div>-->
                                    <!--</th>-->
                                    <th class="min-w-80px fw_800 pb-8">Paper Terms</th>
...
<div class="modal fade" id="kt_modal_academic_order" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        {{-- <form action="{{ url('admin/paper_terms/store') }}" method="POST" enctype="multipart/form-data">
            @csrf --}}
        <form >
        ...
        <div class="modal-content  badge-custom-bg">
            <div class="modal-header">
                <h5 class="modal-title fs-color-white custom-fs-23" id="exampleModalLabel">Paper Terms</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                    <span class="required fs-color-white custom-fs-13">Paper Terms</span>
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg btn-dark-primary form-control-solid titlename"  name="title" placeholder="Paper Terms" />
                <!--end::Input-->
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content badge-custom-bg">
            ...
            <div class="modal-body">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg btn-dark-primary form-control-solid titleset" name="title" placeholder="Paper Terms" value="Paper Terms" />
                <input type="hidden" class="form-control form-control-lg btn-dark-primary form-control-solid titlesetid" name="titleid" placeholder="Paper Terms" value="Paper Terms" />
                <!--end::Input-->
    ...
    function confirmDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'get',
                 //   url: '/admin/paper_terms/delete/' + id,
                    
                      url: "{{ route('admin.paper_terms.destroy', ['id' => ':id']) }}".replace(':id', id),
...
$(document).ready(function (){
        $('.formatclick').on('click', function (){
            ...
            $.ajax({
                url: '{{ url("admin/paper_terms/store") }}',
                type: 'POST',
...
//Request Post Edit
        $('.format_changes').on('click', function (){
            ...
            $.ajax({
                url: '{{ url("admin/paper_terms/update") }}',
                type: 'POST',
                data: {
                        'title_id': title_id,
                        'title': title_name
                ...
                location.reload();
                    ...
                    // var contentUrl = '/admin/paper_termss'; // Replace with the actual URL
