    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">New Orders</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{route('admin.dashboard')}}" class="btn btn-sm fw-bold btn-primary badge-custom-bg">Back</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                                ...
                                <form
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="reset"
                                                    class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.new-order')}}' ">Reset</button>
                                                <button type="submit"
                ...
                <div class="card-body py-4">
                    ...
                    <form method="POST" action="{{ route('admin.updateStatus') }}">
                        ...
                        <button class="btn btn-light-primary me-3 badge-custom-bg" type="submit">Update Status</button>
                       @csrf
                       @method('PUT')
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                                ...
                                <tbody class="text-gray-600 fw-semibold text-color">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                            <input class="form-check-input" type="checkbox" name="selectedProducts[]" value="{{ $o->order_id }}"/>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm badge-custom-bg" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 badge-custom-bg " data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <ul class="ps-0">
                                                                <li><a href="order-details.php" class="menu-link d-flex justify-content-center px-3 text-color" data-bs-toggle="modal" data-bs-target="#view-invoice_{{$o->id}}">View</a></li>
                                                                        ...
                                                                        <div class="d-flex flex-column flex-xl-row">
                                                                            ...
                                                                            <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                                                                ...
                                                                                <div class="mt-n1">
                                                                                    ...
                                                                                    <div class="m-0">
                                                                                        <!--begin::Label-->
                                                                                        <div class="fw-bold custom-fs-13 fs-color-white mb-8">Order #{{$o->order_id}}</div>
                                                                                        <!--end::Label-->
                                                                                        <!--begin::Row-->
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Subject:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->subject}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Academic level:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->academic_level}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Type of Paper:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->type_of_paper}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Paper Format:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->paper_format}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Language and Spelling:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->language_spelling}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Number of pages:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->number_of_pages}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            {{-- <div class="col-md-3"> --}}
                                                                                                <!--end::Label-->
                                                                                                {{-- <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Spacing:</div> --}}
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                {{-- <div class="fw-bold custom-fs-13 fs-color-white">{{$o->spacing}}</div> --}}
                                                                                                <!--end::Text-->
                                                                                            {{-- </div> --}}
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Power Point Slides:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->powerpoint_slide}}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">No# Extra Sources:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->no_of_extra_sources}}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Order Date:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white"> {{ \Carbon\Carbon::parse($o->created_at)->addMonth()->format('d F Y h:iA')  }}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">DeadLine:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{ \Carbon\Carbon::parse($o->deadline)->addMonth()->format('d F Y h:iA') }}</div>
                                                                                                <!--end::Text-->
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Order Type:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->order_type}}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Order Status:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{$o->order_status}}</div>
                                                                                                <!--end::Text-->
                                                                                        ...
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                ...
                                                                                                <div class="col-md-12">
                                                                                                    <!--end::Label-->
                                                                                                    <div class="fw-semibold custom-fs-13 fs-color-white mb-1">Description:</div>
                                                                                                    <!--end::Label-->
                                                                                                    <!--end::Text-->


                                                                                                    <div class="fw-bold custom-fs-13 fs-color-white">{!! $o->description !!}</div>
                                            ...
                                            <select name="order_status" id="order_status" class="btn btn-light-primary me-3 badge-custom-bg">
