                                                                                    ...
                                                                                    <div class="m-0">
                                                                                        ...
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                ...
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white"> {{ \Carbon\Carbon::parse($o->created_at)->format('d F Y h:iA')  }}</div>
                                                                                                <!--end::Text-->
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                ...
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold custom-fs-13 fs-color-white">{{ \Carbon\Carbon::parse($o->deadline)->format('d F Y h:iA') }}</div>
                                                                                                <!--end::Text-->
