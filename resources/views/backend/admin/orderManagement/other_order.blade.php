                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">Other Orders</h1>
                                <!--end::Title-->
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="mb-3 d-flex justify-content-center">
                                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">Refund Orders</h1>
                                </div>
                                <!--begin::Card header-->
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
	                                                            <div class="fs-5 text-gray-900 fw-bold fs-color-white custom-fs-23">Filter Options</div>
	                                                        </div>
	                                                        <!--end::Header-->
	                                                        <!--begin::Separator-->
	                                                        ...
	                                                        <form
                                        id="filterForm"
                                        action="{{ route('admin.other-order') }}"
                                        method="GET"
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="reset"
                                                    class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.other-order')}}' ">Reset</button>
                                                <button type="submit"
                                        ...
                                        <!--end::Content-->
                                            ...
                                            onclick="window.location.href='{{ route('admin.export.orders',['value' => 'Refund']) }}'"
                                            >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm badge-custom-bg" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 badge-custom-bg" data-kt-menu="true">
                                                          ...
                                                          <li><a href="#" class="menu-link d-flex justify-content-center px-3 text-white" data-bs-toggle="modal" data-bs-target="#view-invoice_{{$o->id}}">View</a></li>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <!--<div class="menu-item px-3">-->
                                                            <!--    <a class="menu-link d-flex justify-content-center px-3" onclick="confirmDelete({{$o->id}})">Delete</a>-->
                                                            <!--</div>-->
                                                            <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}}, 'Pending')">New</a></li>
                                                            <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}},'In-Progress')">In-Progress</a></li>
                                                                <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}},'Completed')">Completed</a></li>
                                                                <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}},'Delivered')">Delivered</a></li>
                                                                <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}},'Revision')">Revision</a></li>
                                                                    <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}},'Refund')">Refund</a></li>
                                                                    <li><a class="menu-link d-flex justify-content-center px-3 text-color" onclick="delivered({{$o->id}},'Canceled')">Canceled</a></li>
                                                                        ...
                                                                        <div class="d-flex flex-column flex-xl-row">
                                                                            ...
                                                                            <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                                                                ...
                                                                                <div class="mt-n1">
                                                                                    ...
                                                                                    <div class="m-0">
                                                                                        <!--begin::Label-->
                                                                                        <div class="fw-bold fs-color-white custom-fs-13 mb-8">Order #{{$o->order_id}}</div>
                                                                                        <!--end::Label-->
                                                                                        <!--begin::Row-->
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Subject:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->topic}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Academic level:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->academic_level}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Type of Paper:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->type_of_paper}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Paper Format:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->paper_format}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Language and Spelling:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->language_spelling}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Number of pages:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->number_of_pages}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            {{-- <div class="col-md-3"> --}}
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Power Point Slides:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->powerpoint_slide}}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">No# Extra Sources:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->no_of_extra_sources}}</div>
                                                                                                <!--end::Text-->
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                ...
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13"> {{ \Carbon\Carbon::parse($o->created_at)->format('d F Y h:iA')  }}</div>
                                                                                                <!--end::Text-->
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                ...
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{ \Carbon\Carbon::parse($o->deadline)->format('d F Y h:iA') }}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Statistical Analysis:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{($o->statistical_analysis == 1) ? 'Yes' : 'No' }}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Order Type:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->order_type}}</div>
                                                                                                <!--end::Text-->

                                                                                            </div>
                                                                                            <div class="col-md-3">
                                                                                                <!--end::Label-->
                                                                                                <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Order Status:</div>
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->order_status}}</div>
                                                                                                <!--end::Text-->
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid mb-5">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card">
                                ...
                                <!--end::Page title-->
                                <div class="mb-3 d-flex justify-content-center">
                                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">Cancelled Orders</h1>
                                </div>
                                <!--begin::Card header-->
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <!--end::Content-->
                                            ...
                                            <button type="button" class="btn btn-light-primary me-3 badge-custom-bg"
                                            {{-- data-bs-toggle="modal" data-bs-target="#kt_modal_export_users" --}}
                                            onclick="window.location.href='{{ route('admin.export.orders',['value' => 'Canceled']) }}'"
                                            >
                                                <i class="ki-duotone ki-exit-up fs-2">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                ...
                                <div class="card-body py-4">
                                    <!--begin::Table-->
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_cancelledOrder">
											<thead>
	                                            {{-- <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
	                                                <th class="w-10px pe-2 pb-8">
	                                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
	                                                ...
	                                                <th class="min-w-80px fw_800 pb-8 fs-color-white">Due Date</th>
	                                                <th class="min-w-80px fw_800 pb-8 fs-color-white">Status</th>
	                                                <th class="min-w-50px fw_800 pb-8 fs-color-white">Action</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm badge-custom-bg" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 badge-custom-bg" data-kt-menu="true">
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="#" class="menu-link d-flex justify-content-center px-3 text-white text-white" data-bs-toggle="modal" data-bs-target="#view-invoice-canceled_{{$o->id}}">View</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="confirmDelete({{$o->id}})">Delete</a>
                                                            </div>
                                                              <div class="menu-item px-3">
                <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}}, 'Pending')">New</a>
                 <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'In-Progress')">In-Progress</a>
                  <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Completed')">Completed</a>
                   <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Delivered')">Delivered</a>
                    <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Revision')">Revision</a>
                     <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Refund')">Refund</a>
                      <a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Canceled')">Canceled</a>
            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="/images/myw3schoolsimage.jpg" class="menu-link d-flex justify-content-center px-3 text-white" download>Download</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                        </div>
                                                    </td>
                                                </tr>
                                                <div class="modal fade view-invoice" id="view-invoice-canceled_{{$o->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                                        <div class="modal-content badge-custom-bg">
                                                            <div class="modal-header border-0">
                                                                {{-- <h5 class="modal-title" id="exampleModalLabel">Invoice</h5> --}}
                                                                                    ...
                                                                                    <div class="m-0">
                                                                                        ...
                                                                                        <div class="row g-5 mb-12">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                ...
                                                                                                <!--end::Label-->
                                                                                                <!--end::Text-->
                                                                                                <div class="fw-bold fs-color-white custom-fs-13">{{$o->subject}}</div>
                                                                                                <!--end::Text-->
                                                                                            </div>
                                                                                            <!--end::Col-->
                                                                                            <!--end::Col-->
...
<script>
    $(document).ready(function () {
        // Initialize DataTables
        var table = $('#kt_table_cancelledOrder').DataTable();
   ...
   console.log(id);
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var url = '{{ route("admin.deleverd_order", ["id" => ":id"]) }}';
