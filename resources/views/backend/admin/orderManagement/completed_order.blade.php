    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">Completed Orders</h1>
                <!--end::Title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                ...
                                <form
                                        id="filterForm"
                                        action="{{ route('admin.completed-order') }}"
                                        method="GET"
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="reset"
                                                    class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.completed-order')}}' ">Reset</button>
                                                <button type="submit"
                            ...
                            onclick="window.location.href='{{ route('admin.export.orders',['value' => 'Completed']) }}'"
                            >
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-color-white custom-fs-13"> {{ \Carbon\Carbon::parse($o->created_at)->addMonth()->format('Y/m/d h:iA') }}</div>
                                                <!--end::Text-->
