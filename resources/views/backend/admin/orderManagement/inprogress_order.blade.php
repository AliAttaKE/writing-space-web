    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">In-progress Orders</h1>
                <!--end::Title-->
                                ...
                                <form
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="reset"
                                                    class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.inprogress-order')}}' ">Reset</button>
                                                <button type="submit"
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                {{-- <th class="min-w-70px fw_800 pb-8"><input type="checkbox" id="selectAll"></th> --}}
                    ...
                    <tr>
                        {{-- <td>
                            ...
                            <input type="checkbox" name="selectedProducts[]" value="{{ $o->order_id }}">
                            </div>
                        </td>  --}}
                                                        ...
                                                        <div class="m-0">
                                                            ...
                                                            <div class="row g-5 mb-12">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--end::Text-->
                                                                    <div class="fw-bold custom-fs-13 fs-color-white"> {{ \Carbon\Carbon::parse($o->created_at)->addMonth()->format('Y/m/d h:iA') }}</div>
                                                                    <!--end::Text-->
