...
{{-- 
 <div class="my-1">
  ...
  <a href="{{ route('admin.orders_history') }}" class="btn btn-secondary">Reset</a>
...
$(document).on('click', '.send-email', function() {
    ...
    let emailType = $(this).data('type');
    let button = $(this);

    button.prop('disabled', true).text('Sending...');

    $.ajax({
        url: "{{ route('admin.orders.sendReminder') }}",
        method: "POST",
        data: {
            _token: "{{ csrf_token() }}",
            order_id: orderId,
        ...
        complete: function() {
            button.prop('disabled', false).text(emailType == 3 ? '📧 Friendly Reminder' : '⚠️ Final Notice');
        }
    });
});
