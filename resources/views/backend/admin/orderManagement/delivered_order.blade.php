    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">Delivered Orders</h1>
                <!--end::Title-->
                                ...
                                <form
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="reset"
                                                    class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.delivered-order')}}' ">Reset</button>
                                                <button type="submit"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-80px fw_800 pb-8">Revision Request</th>
...
<tr>
    ...
    <td>
        @if($o->revision_status == 'revision status')
            <span class="badge badge-light-success fw-bold me-auto px-4 py-3">{{$o->revision_status}}</span>
        @else
            <span class="badge fw-bold me-auto px-4 py-3 badge-custom-bg">N/A</span>
        @endif
...
<div class="modal fade view-invoice" id="view-revision_update_{{$o->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title" id="exampleModalLabel">Revision Date Update</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="col-md-12">
                                                    <!--end::Label-->
                                                    <div class="fw-semibold fs-7 text-gray-600 mb-1">Revision Date:</div>
                                                    <!--end::Label-->
                                                    <!--end::Text-->
                                                   <?php
