					...
					<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center text-color my-0">Order Detail</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">
										<a href="#" class="text-muted text-hover-primary">Place Order</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">{{$order->order_id}}</li>
									<!--end::Item-->
									<!--begin::Item-->
								</ul>
								<!--end::Breadcrumb-->
							...
							<div class="d-flex flex-column flex-xl-row mb-5">
								...
								<div class="flex-lg-row-fluid">
									...
									<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
										<!--begin:::Tab item-->
										<li class="nav-item">
											<a class="nav-link text-active-primary pb-4 defBtn tabBtn" data-bs-toggle="tab" href="#kt_ecommerce_customer_details">Order Details</a>
										</li>
										<li class="nav-item">
											<a class="nav-link text-active-primary pb-4 tabBtn" data-bs-toggle="tab" href="#kt_ecommerce_customer_messages">Messages</a>
										</li>
										<li class="nav-item">
											...
											<div class="d-flex justify-content-center">
												<div class="col-11">
													...
													<div class="card">
														...
														<div class="card-header align-items-center justify-content-end py-5 gap-5 btn-dark-primary">
															<!--begin::Actions-->
															<!--end::Actions-->
															<!--begin::Pagination-->
														...
														<div class="card-body">
                                                            ...
                                                            <form id="kt_inbox_reply_form" class="rounded border mb-10 btn-dark-primary">
                                                                ...
                                                                <div class="d-block">
                                                                    ...
                                                                    <div class="d-flex align-items-center border-bottom px-6 min-h-50px justify-content-between py-5 btn-dark-primary">
                                                                        ...
                                                                        <div class="border d-flex p-3 align-items-center rounded me-3">
                                                                            ...
                                                                            <div class="btn btn-icon btn-sm btn-clean btn-active-light-primary me-2 badge-custom-bg" id="media_button" data-kt-inbox-form="dropzone_upload">
                                                                                <label><span class="ki-duotone ki-paper-clip fs-2 m-0 text-color"></span><input hidden type="file" class="upload-attachment" name="media[]" id="media" multiple/></label>
                                                                            </div>
                                                                        ...
                                                                        <div class="text-center me-3">
                                                                            <input class="form-select form-select-solid form-select-sm badge-custom-bg" value="{{$order->order_id}}" name='order_id' hidden>
                                                                    ...
                                                                    <div id="messageEditor" class="border-0 bg-transparent h-250px px-3">
																	</div>
                                                                    <!--end::Message-->
                                                                    <!--begin::Attachments-->
											...
											<div class="card card-flush">
												...
												<div class="card-title pt-8 ps-8">
													...
													<div class="d-flex align-items-center position-relative my-1">
														...
														<!--<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15 btn-dark-primary" placeholder="Search Files &amp; Folders">-->
												...
												<div class="card-body custom-overflow-x-auto p-0">
													...
													<!--end::Table header-->
													<!--begin::Table-->
													<div id="kt_file_manager_list_wrapper" class="dataTables_wrapper cus-table dt-bootstrap4 no-footer">
															...
															<table id="kt_file_manager_list" data-kt-filemanager-table="files" class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
																<thead>
																	<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
																		...
																		<th class="min-w-10px sorting_disabled text-color" rowspan="1" colspan="1" style="width: 66.4062px;">Size</th>
																		<th class="min-w-125px sorting_disabled text-color" rowspan="1" colspan="1" style="width: 250.656px;">Last Modified</th>
																		<th class="min-w-10px sorting_disabled text-color" rowspan="1" colspan="1" style="width: 66.4062px;">Download Time</th>
...
document.getElementById("media").addEventListener("change", function() {
			...
			document.getElementById("file_name").innerText = "Selected file: " + fileName;
		});
...
<script>
    ...
    form.onsubmit = function() {
        ...
        form.querySelector('textarea[name=order-msg]').value = quillContent;
    };
</script>
<script>
