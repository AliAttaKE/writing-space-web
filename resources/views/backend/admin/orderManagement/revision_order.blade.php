...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <!--begin::Page title-->
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 text-color">Revision Orders</h1>
                <!--end::Title-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset"
                                            class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.revision-order')}}' ">Reset</button>
                                        <button type="submit"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content badge-custom-bg">
            <div class="modal-header border-0">
                <h5 class="modal-title custom-fs-23 fs-color-white" id="exampleModalLabel">Revision</h5>
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="col-md-12 fs-color-white custom-fs-13">
                                                    ...
                                                    ?>
                                                    <!--end::Label-->
                                                    <div class="fw-semibold fs-color-white custom-fs-13 mb-1">Revision Request:</div>
                                                    <div class="fw-bold fs-color-white custom-fs-13">
                                                        @if($revisionSubmit){!! $revisionSubmit->revision_request !!}@endif</div>
                                                    <!--end::Label-->
                                                    <!--end::Text-->
