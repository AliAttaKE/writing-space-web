                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="text-muted fw-bold">
                                ...
                                <a class="fs-color-yellow" href="{{ url('/admin/folders/show') }}">Folder Management</a>
            ...
            @if ($files->isNotEmpty())
                ...
                <div class="card card-flush mb-10">
                    ...
                    <div class="row px-8 justify-content-end">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                            <button type="button" class="btn btn-flex btn-primary w-100 justify-content-center px-2 badge-custom-bg deleteBtnForm" 
                                style="display: none;"
                                >
                                Delete</button>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-5 mb-2">
                            <button type="button" class="btn btn-flex btn-primary w-100 justify-content-center px-2 badge-custom-bg downloadBtnForm" 
                                style="display: none;"
                                >
                                Download</button>
                        </div>
                    ...
                    <div class="card-body overflow-auto">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="badge badge-lg badge-light-primary mb-2 badge-custom-bg">
                                    <div class="d-flex align-items-center flex-wrap">
                                        ...
                                        <a class="text-color" href="{{ url('/admin/folders/show') }}"> Writing Space</a>
                                        <i class="ki-duotone ki-right fs-2x mx-1 text-white"></i>

                                        <a class="text-color" href="{{ url('/admin/folders/show') }}">Folder</a>
                                        <i class="ki-duotone ki-right fs-2x mx-1 text-white"></i>
                        ...
                        <!--end::Table header-->
                        <form id="delete_or_download_form" action="{{ route('admin.folders.view.all', ['id'=> $folder->id]) }}" method="GET" enctype="multipart/form-data">
                        ...
                        <table id="kt_file_manager_list" data-kt-filemanager-table="files"
                            ...
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 text-color">
                                    ...
                                    <th class="min-w-250px " rowspan="1" colspan="1"
                                        >File Title</th>
                                    ...
                                    <tr class="odd">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input custom-input" type="checkbox" name="selected_ids[]" value="{{ $file->id }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4 badge-custom-bg"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('admin.files.download', ['id' => $file->id, 'folder_name' => $folder->name]) }}"
                                                                class="menu-link px-3 text-white downloadPdf">Download File</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a class="menu-link text-white px-3"
                                                                onclick="confirmDelete({{ $file->id }}, '{{ $folder->name }}')">Delete</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
                                    ...
                                    <tr class="odd">
                                        <td valign="top" colspan="5" class="dataTables_empty">
                                            <div class="d-flex flex-column flex-center">
                                                ...
                                                <div class="fs-6">Strat uploading new files!
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
