            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0 text-color  custom-fs-23">Users Activity Log</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <!-- <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item fs-color-white custom-fs-13">Users Activity Log</li>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="badge badge-custom-bg fw-bold">{{ $formattedTime = formatTime($user->created_at) }}</div>
                                    </td>
                                    ...
                                    @else
                                        <td>
                                            <div class="badge badge-custom-bg fw-bold">{{ $formattedTime = formatTime($user->logout_time); }}</div>
                                        </td>
                                    @endif
                                    
                                    <td class="text-end">
                                        <div class="badge badge-custom-bg fw-bold">{{ $user->created_at ? $user->created_at->diffForHumans() : 'N/a' }}</div>
                                    </td>
                                </tr>
                                   @endforeach
