    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Promotion Offers</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" class="form-control form-control-lg form-control-solid titleset" oninput="validateDiscount(this)"  name="discount" placeholder="Discount" value="{{$coupon->discount}}" />
                                                            <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid" name="titleid" placeholder="Service Type" value="Service Type" />
                                                            <!--end::Input-->
                                                            <div>
                                                                <div class="mb-3">
