    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0">Promotion Offers</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Promotion Offers</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td> {{ $coupon->decrease_everyday}}</td>
                                    <td> {{ $coupon->status}}</td>
                                    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <a href="#" class="menu-link d-flex justify-content-center px-3 edit1" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order_edit_{{$coupon->id}}">Edit</a>
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link d-flex justify-content-center px-3" onclick="confirmDelete({{ $coupon->id}})">Delete</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="kt_modal_academic_order_edit_{{$coupon->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('admin.promotion.update',[$coupon->id]) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" class="form-control form-control-lg form-control-solid titlename" name="title" placeholder="Title" value="{{$coupon->title}}"/>
                                                    <!--end::Input-->
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-solid titlename" id="description" name="description" placeholder="Description" value="{{$coupon->description}}"/>
                                                    <!--end::Input-->
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" class="form-control form-control-lg form-control-solid titleset" name="coupon" placeholder="Code" value="{{$coupon->coupon}}" />
                                                    <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid" name="titleid" placeholder="Service Type" value="Service Type" />
                                                    <!--end::Input-->
                                                    <div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" class="form-control form-control-lg form-control-solid titleset" name="discount" placeholder="Discount" value="{{$coupon->discount}}" />
                                                            <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid" name="titleid" placeholder="Service Type" value="Service Type" />
                                                            <!--end::Input-->
                                                            <div>
                                                                <div class="mb-3">
                                                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                                                        <span class="required">Start_date</span>
                                                                        <span class="ms-1" data-bs-toggle="tooltip" title="Specify your unique app name">
                                                                            <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>
                                                                    </label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="date" class="form-control form-control-lg form-control-solid titleset" name="start_date" placeholder="Start_date" value="{{$coupon->start_date}}" />
                                                                    <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid" name="titleid" placeholder="Service Type" value="Service Type" />
                                                                    <!--end::Input-->
                                                                    <div>
                                                                        <div class="mb-3">
                                                                            <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                                                                <span class="required">End_date</span>
                                                                                <span class="ms-1" data-bs-toggle="tooltip" title="Specify your unique app name">
                                                                                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>
                                                                            </label>
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="date" class="form-control form-control-lg form-control-solid titleset" name="end_date" placeholder="End_date" value="{{$coupon->end_date}}"/>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="number" class="form-control form-control-lg form-control-solid titlename" name="decrease_everyday" placeholder="Add Discount" value="{{$coupon->decrease_everyday}}"/>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <select class="form-control form-control-lg form-control-solid titlename" name="status" value="{{$coupon->status}}">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary format_changes">Save changes</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-lg form-control-solid titlename" name="discount" placeholder="Add Discount" />
