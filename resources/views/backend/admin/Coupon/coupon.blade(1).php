    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0">Coupon</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Coupon</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-lg form-control-solid titlename" id="code" name="code" placeholder="Code" />
                        <!--end::Input-->
                    </div>
                    <div class="mb-3">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                            <span class="required">Discount Value</span>
                            <span class="ms-1" data-bs-toggle="tooltip" title="Specify your unique app name">
                                <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select class="form-control" name='discount_value'>
                            <option selected>Choose Discount Value
                            <option>
                    ...
                    <div class="mb-3">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-lg form-control-solid titlename numbers-only1" name="discount" placeholder="Add Discount" />
                    ...
                    <div class="mb-3">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                            <span class="required">Total Users</span>
                            <span class="ms-1" data-bs-toggle="tooltip" title="Specify your unique app name">
                                <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-lg form-control-solid numbers-only2 " name="total_user" placeholder="Total use" />
                    ...
                    <div class="mb-3">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                            <span class="required">Per User use</span>
                            <span class="ms-1" data-bs-toggle="tooltip" title="Specify your unique app name">
                                <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-lg form-control-solid titleset numbers-only3" name="per_user_use" placeholder="Per User use" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" class="form-control form-control-lg form-control-solid titleset titlesetclass" name="code" placeholder="Code" value="code" />
                    <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid " name="titleid" placeholder="" value="" />
                    <!--end::Input-->
                    <div>
                        ...
                        <div class="mb-3">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid discountset numbers-only4" name="discount" placeholder="Discount" value="discount" />
                            ...
                            <div>
                                <div class="mb-3">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="date" class="form-control form-control-lg form-control-solid start_dateset" name="start_date" placeholder="Start_date" value="start_date" />
                                    <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid" name="titleid" placeholder="" value=" "/>
                                    <!--end::Input-->
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="date" class="form-control form-control-lg form-control-solid end_dateset" name="end_date" placeholder="End_date" />
