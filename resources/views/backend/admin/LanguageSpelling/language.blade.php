    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 fs-color-white custom-fs-23">Languages</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_academic_order">Languages Order</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <!--    </div>-->
                                    <!--</th>-->
                                    <th class="min-w-80px fw_800 pb-8">Languages</th>
...
<div class="modal fade" id="kt_modal_academic_order" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        {{-- <form action="{{ url('admin/Languages/store') }}" method="POST" enctype="multipart/form-data">
            @csrf --}}
        <form >
        ...
        <div class="modal-content badge-custom-bg">
            <div class="modal-header">
                <h5 class="modal-title fs-color-white custom-fs-23" id="exampleModalLabel">Languages</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                    <span class="required fs-color-white custom-fs-13">Languages</span>
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg form-control-solid titlename btn-dark-primary"  name="title" placeholder="Languages" value="" />
                <!--end::Input-->
            </div>
...
<div class="modal fade editmodel" id="kt_modal_academic_order_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content badge-custom-bg">
            <div class="modal-header">
                <h5 class="modal-title fs-color-white custom-fs-13" id="exampleModalLabel">Languages</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!--begin::Label-->
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-lg form-control-solid titleset btn-dark-primary" name="title" placeholder="Languages" value="Languages" />
                <input type="hidden" class="form-control form-control-lg form-control-solid titlesetid btn-dark-primary" name="titleid" placeholder="Languages" value="Languages" />
                <!--end::Input-->

            </div>
            <div class="modal-footer">
                
                <button type="button" class="btn badge-custom-bg-2 format_changes">Save changes</button>
            </div>
        </div>
    </div>
    </form>
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                   ...
                   // url: '/admin/languages/delete/' + id,
                      url: "{{ route('admin.languages.destroy', ['id' => ':id']) }}".replace(':id', id),
...
//Request Post Edit
        $('.format_changes').on('click', function (){
            ...
            $.ajax({
                url: '{{ url("admin/languages/update") }}',
                type: 'POST',
                data: {
                        'title_id': title_id,
                        'title': title_name
                ...
                location.reload();
                    ...
                    // var contentUrl = '/admin/Languagess'; // Replace with the actual URL
