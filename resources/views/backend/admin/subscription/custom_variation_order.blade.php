                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                                ...
                                                <form
                                                        id="filterForm"
                                                        action="{{ route('admin.custom-setting-order') }}"
                                                        method="GET"
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <button type="reset" class="btn btn-dark-primary fw-semibold me-2 px-6" onclick="window.location.href = '{{route('admin.custom-setting-order')}}' ">Reset</button>
