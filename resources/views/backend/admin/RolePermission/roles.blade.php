                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0 fs-color-white custom-fs-23">Roles List</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <!-- <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <li class="breadcrumb-item fs-color-white custom-fs-13">Roles</li>
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1 me-5">
                                            ...
                                            <input type="text" data-kt-permissions-table-filter="search" class="form-control form-control-solid btn-dark-primary w-250px ps-13" placeholder="Search Roles" />
                                        </div>
                                        <!--end::Search-->
                                    </div>
                                    <!--end::Card title-->
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <button type="button" class="btn badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">
                            ...
                            <!--begin::Row-->
                            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-2 g-5 g-xl-9" id="user-roles">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card card-flush h-md-100">
                                                ...
                                                <div class="card-header">
                                                    <!--begin::Card title-->
                                                    <div class="card-title">
                                                        <h2 class="fs-color-white custom-fs-23 user-name">
                                                            {{ $role->name }}
                                                        </h2>
                                                ...
                                                <div class="card-body pt-1">
                                                    <!--begin::Users-->
                                                    <div class="fw-bold fs-color-white custom-fs-17 mb-5">Total users with this role: {{ getTotalUsersWithRole($role->name) }}</div>
                                                    <!--end::Users-->
                                                    <!--begin::Permissions-->
                                                ...
                                                <div class="card-footer flex-wrap pt-0">
                                                    <a href="{{ route('admin.view.role', ['role_id' => $role->id]) }}" class="btn badge-custom-bg my-1 me-2">View Role</a>
                                                    <button type="button" class="btn badge-custom-bg my-1 deleteRoleBtn" data-id="{{ $role->id }}">Delete Role</button>
                                                </div>
                                                <!--end::Card footer-->
                                            </div>
                                            <!--end::Card-->
                            ...
                            <div class="modal fade" id="kt_modal_add_role" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-750px">
                                    ...
                                    <div class="modal-content badge-custom-bg">
                                        ...
                                        <div class="modal-header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bold fs-color-white custom-fs-23">Add a Role </h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                             ...
                                             <form id="kt_modal_add_role_form" class="form" >
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_role_header" data-kt-scroll-wrappers="#kt_modal_update_role_scroll" data-kt-scroll-offset="300px">
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-solid btn-dark-primary" placeholder="Enter a role name" name="name" value="{{ old('name') }}" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Permissions-->
                                                    <div class="fv-row">
                                                        <!--begin::Label-->
                                                        <label class="fs-5 fw-bold form-label mb-2 fs-color-white custom-fs-13">Role Permissions</label>
                                                        <!--end::Label-->
                                                        <!--begin::Table wrapper-->
                                                        <div class="table-responsive">
                                                            <!--begin::Table-->
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                                                ...
                                                                                <span class="form-check-label fs-color-white custom-fs-13" for="kt_roles_select_all_2">Select all</span>
                                                                            </label>
                                                                            <!--end::Checkbox-->
                                                                        </td>
                                                                    </tr>
                                                                                ...
                                                                                @foreach ($permissions as $permission )   
                                                                                        ...
                                                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                                                            <input class="form-check-input btn-dark-primary" type="checkbox"
                                                                                              ...
                                                                                              />
                                                                                            <span class="form-check-label fs-color-white custom-fs-13">{{ $permission->name }}</span>
                                                                                        </label>
                                                                                        <!--end::Checkbox-->
                                                                                @endforeach
                                                ...
                                                <div class="text-center pt-15">
                                                    ...
                                                    <button type="button" class="btn btn-dark-primary submitAddRole" >
                                                        <span class="indicator-label">Submit</span>
                                                        <span class="indicator-progress">Please wait...
                                                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                    </button>
...
<script>
    $(document).ready(function() {
        ...
        $('[data-kt-permissions-table-filter="search"]').on('input', function() {
            var searchText = $(this).val().trim().toLowerCase();

            $('#user-roles .user-name').each(function() {
                var roleName = $(this).text().toLowerCase();

                // Show/hide user roles based on search input
                if (roleName.includes(searchText)) {
                    $(this).closest('.col-md-4').show();  // Show the role card
                } else {
                    $(this).closest('.col-md-4').hide();  // Hide the role card
                }
            });
        });
    });
