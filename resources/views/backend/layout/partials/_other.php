                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0">Other Orders</h1>
                                <!--end::Title-->
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="mb-3 d-flex justify-content-center">
                                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0">Refund Orders</h1>
                                </div>
                                <!--begin::Card header-->
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid mb-5">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card">
                                ...
                                <!--end::Page title-->
                                <div class="mb-3 d-flex justify-content-center">
                                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0">Cancelled Orders</h1>
                                </div>
                                <!--begin::Card header-->
                                <div class="card-header border-0 pt-6">
