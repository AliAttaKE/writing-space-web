                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0 fs-color-white">File Management - Files</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="2190302.php" class="text-gray-800 text-hover-primary">2190302</a>
                                                    </div>
                                                </td>
                                                <td>2 Mb</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="icon-wrapper"><i class="ki-duotone ki-folder fs-2x text-primary me-4"><span class="path1"></span><span class="path2"></span></i></span>
                                                        <a href="2194282.php" class="text-gray-800 text-hover-primary">2194282</a>
                                                    </div>
                                                </td>
                                                <td>0.8 Mb</td>
                                                <td>16 Aug 2023, 2:40 pm</td>
                                                <td class="" data-kt-filemanager-table="action_dropdown">
                                                    <div class="d-flex">
                                                        <!--begin::Share link-->
                                                        <div class="ms-2" data-kt-filemanger-table="copy_link">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="icon-wrapper"><i class="ki-duotone ki-folder fs-2x text-primary me-4"><span class="path1"></span><span class="path2"></span></i></span>
                                                        <a href="2048211.php" class="text-gray-800 text-hover-primary">2048211</a>
                                                    </div>
                                                </td>
                                                <td>1.3 Mb</td>
                                                <td>29 Aug 2023, 2:40 pm</td>
                                                <td class="" data-kt-filemanager-table="action_dropdown">
                                                    <div class="d-flex">
                                                        <!--begin::Share link-->
                                                        <div class="ms-2" data-kt-filemanger-table="copy_link">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="icon-wrapper"><i class="ki-duotone ki-folder fs-2x text-primary me-4"><span class="path1"></span><span class="path2"></span></i></span>
                                                        <a href="2910381.php" class="text-gray-800 text-hover-primary">2910381</a>
                                                    </div>
                                                </td>
                                                <td>1.7 Mb</td>
                                                <td>291 Aug 2023, 2:40 pm</td>
                                                <td class="" data-kt-filemanager-table="action_dropdown">
                                                    <div class="d-flex">
                                                        <!--begin::Share link-->
                                                        <div class="ms-2" data-kt-filemanger-table="copy_link">
