...
<div class="
    ...
    <div class="
        ...
        <!--begin:Menu item-->
        <div class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><a href="menu-link" class=""> <span class="menu-link"><span class="menu-title"><a href="{{route('front.index')}}" class="active custom-menu">Home</a></span><span class="menu-arrow d-lg-none"></span></span><!--end:Menu link-->
        </div><!--end:Menu item-->
        <!--begin:Menu item-->
