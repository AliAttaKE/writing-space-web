                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0  fs-color-white custom-fs-23">View Role Details</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item fs-color-white custom-fs-13">View Roles</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="card card-flush">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-title">
                                                <h2 class="mb-0 fs-color-white custom-fs-23">{{ $roles->name === 'is_admin' ? 'Admin' : 'Customer' }}</h2>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--end::Card header-->
                                        ...
                                        <div class="card-body pt-0">
                                            <!--begin::Permissions-->
                                            <div class="d-flex flex-column fs-color-white custom-fs-13">
                                                @php $count = 10; @endphp

                                                @foreach ($permissions as $key => $per)
                                                    @if($loop->iteration <= $count)
                                                        <div class="d-flex align-items-center py-2">
                                                            <span class="bullet bg-primary me-3 fs-color-white custom-fs-23"></span>{{ $per->name }}
                                                        </div>
                                                    @endif
                                                @endforeach
                                                
                                                <div class="d-flex align-items-center py-2">
                                                    <span class="bullet bg-primary me-3 fs-color-white custom-fs-23"></span>... more
                                                </div>
                                            </div>
                                            <!--end::Permissions-->
                                        </div>
                                        ...
                                        <div class="card-footer pt-0">
                                            <button type="button" class="btn badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role">Edit Role</button>
                                        </div>
                                        <!--end::Card footer-->
                                    </div>
                                    <!--end::Card-->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-750px">
                                            ...
                                            <div class="modal-content badge-custom-bg">
                                                ...
                                                <div class="modal-header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bold fs-color-white custom-fs-23">Update1 Role</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                    <div class="btn btn-icon btn-sm btn-dark-primary" data-kt-roles-modal-action="close">
                                                ...
                                                <div class="modal-body scroll-y mx-5 my-7">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_update_role_form" class="form" method="post" action="{{ route('admin.update.role.permission') }}">
                                                        <!--begin::Scroll-->
                                                        @csrf
                                                        ...
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_role_header" data-kt-scroll-wrappers="#kt_modal_update_role_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <label class="fs-5 fw-bold form-label mb-2">
                                                                    <span class="required fs-color-white custom-fs-13">Role name</span>
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control form-control-solid btn-dark-primary" placeholder="Enter a role name" name="name" value="{{ $roles->name === 'is_admin' ? 'Admin' : 'Customer' }}" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Permissions-->
                                                            <div class="fv-row">
                                                                <!--begin::Label-->
                                                                <label class="fs-5 fw-bold form-label fs-color-white custom-fs-13 mb-2">Role Permissions</label>
                                                                <!--end::Label-->
                                                                <!--begin::Table wrapper-->
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                                                                        ...
                                                                        <tbody class="text-gray-600 fw-semibold">
                                                                            <!--begin::Table row-->
                                                                            <tr>
                                                                                <td class="fs-color-white custom-fs-13">All Permissions
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                                                        <input class="form-check-input btn-dark-primary" type="checkbox" value="" id="kt_roles_select_all_2" />
                                                                            ...
                                                                            <tr>
                                                                                <!--begin::Label-->
                                                                                <td class="fs-color-white custom-fs-13">{{ $gr->group_name }}</td>
                                                                                <!--end::Label-->
                                                                                <!--begin::Input group-->
                                                                                <td>
                                                                                    <!--begin::Wrapper-->
                                                                                    <div class="d-flex">
                                                                                        ...
                                                                                        @foreach ($permissions as $permission )   
                                                                                                ...
                                                                                                <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                                                                    <input class="form-check-input btn-dark-primary" type="checkbox"
                                                                                                        name="permission[]" 
                                                                                                        value="{{$permission->id}}" 
                                                        ...
                                                        <div class="text-center pt-15">
                                                           <!-- <button type="reset" class="btn btn-dark-primary me-3" data-kt-roles-modal-action="cancel">Discard</button>-->
                                                            <button type="reset" class="btn btn-light me-3 btn-dark-primary" data-bs-dismiss="modal">Discard</button>
                                                            <button type="submit" class="btn btn-dark-primary" data-kt-roles-modal-action="submit">
                                ...
                                <div class="flex-lg-row-fluid ms-lg-10">
                                    <!--begin::Card-->
                                    <div class="card card-flush mb-6 mb-xl-9 card-custom-bg">
                                        <!--begin::Card header-->
                                        <div class="card-header pt-5">
                                            <!--begin::Card title-->
                                            <div class="card-title">
                                                <h2 class="d-flex align-items-center fs-color-white custom-fs-23">Users Assigned
                                                    <span class="text-gray-600 fs-6 ms-1 d-none">(14)</span>
                                                </h2>
                                            </div>
                                            <!--end::Card title-->
                                            <!--begin::Card toolbar-->
                                            <div class="card-toolbar">
                                                ...
                                                <div class="d-flex align-items-center position-relative my-1" data-kt-view-roles-table-toolbar="base">
                                                    <i class="ki-duotone ki-magnifier fs-1 position-absolute ms-6">
                                                     ...
                                                     <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13 btn-dark-primary" placeholder="Search Users" />
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                <a class="text-white" href="view-user.php">
                                                                    <div class="symbol-label">
                                                                        @if($user->avatar)
                                                                            <img src="{{ asset('images/users/admins/'. $user->avatar) }}" alt="Emma Smith" class="w-100" />
                                                                        @else
                                                                            <img src="{{ asset('backend/assets/media/ws/profile.png') }}" alt="Emma Smith" class="w-100" />
                                                                        @endif
                                                                    </div>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <a class="text-white" href="#">{{ $user->id }}</a>
                                                        </td>
                                                        <td>
                                                            <a class="text-white" href="#">{{ $user->name }}</a>
                                                        </td>
                                                        <td class="text-white">
                                                            {{ $user->created_at }}
                                                        </td>
...
function handleTableSearch() {
    ...
    $('#kt_roles_view_table tbody tr').each(function() {
        console.log(this)
...
<script>
    $(document).ready(function () {
        ...
        $('#search').on('input', function () {
            ...
            // Filter the user items based on the search term
...
<script>
    document.getElementById('deleteLink').addEventListener('click', function(event) {
        ...
        Swal.fire({
            name: 'First You Have To Disable Row!',
            icon: 'warning',
            customClass: {
