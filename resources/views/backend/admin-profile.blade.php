    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Admin Profile</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Profile
                    </li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
                        ...
                        <div class="card-body">
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600">{{ Auth::user()->account_id }}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    ...
                                    <div class="text-gray-600">{{ Auth::user()->address_1 }}
                                    ...
                                    <div class="text-gray-600">{{ Auth::user()->language }}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    ...
                                    <div class="text-gray-600">{{ Auth::user()->authenticated_at }}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">State/Province</div>
                                    <div class="text-gray-600">{{ Auth::user()->state }}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Postal Code</div>
                                    <div class="text-gray-600">{{ Auth::user()->postcode }}</div>
                                    <!--begin::Details item-->
                                </div>
                            </div>
                            <!--end::Details content-->
                                            ...
                                            <tbody class="fs-6 fw-semibold text-gray-600">
                                                @foreach ($sessions as $se )
                                                    <tr>
                                                        ...
                                                        <td>
                                                        @if ($se->is_logout == 1)
                                                            <a href="{{ route('admin.destroy.single.session', ['user_id' => $se->user_id]) }}" 
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form" id="kt_modal_update_user_form" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div id="kt_modal_update_user_user_info" class="collapse show">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="email" class="form-control form-control-solid" placeholder="" name="email" value="{{ old('email', $user->email) }}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="description" value="{{ old('description', $user->description) }}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                        ...
                                        <div id="kt_modal_update_user_address" class="collapse show">
                                            ...
                                            <div class="d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input class="form-control form-control-solid" placeholder="" name="address_1" value="{{ old('address_1', $user->address_1) }}" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input class="form-control form-control-solid" placeholder="" name="address_2" value="{{ old('address_2', $user->address_2) }}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                ...
                                <div class="modal-footer flex-center">
                                    ...
                                    <!--end::Button-->
                                    <!--begin::Button-->
                                    <button type="button" class="btn btn-primary updateUserDetails" data-kt-users-modal-action="submit">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <form id="kt_modal_update_email_form"  class="form">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" class="form-control form-control-solid" placeholder="" id="email_update"  name="email" value="{{ old('email', $user->email) }}" />
                                    <p></p>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="text-center pt-15">
                                    <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal">Discard</button>
                                    <button type="button" class="btn btn-primary updateEmail" data-kt-users-modal-action="submit">
                                        <span class="indicator-label">Submit</span>
                                        <span class="indicator-progress">Please wait...
                                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                    </button>
