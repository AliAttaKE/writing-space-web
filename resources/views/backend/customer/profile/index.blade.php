                            ...
                            <div class="row justify-content-between px-3">
                                ...
                                <div class="card pt-4 mb-6 col-md-5 mb-xl-9 card-custom-bg">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fs-7 fw-normal text-muted">Expire Date: {{ \Carbon\Carbon::parse($used_subscription->due_date)->format('F j, Y') }}</div>
                                                ...
                                                <tbody class="fs-6 fw-semibold text-gray-600" id="old_package_payment_tbody">
                                                    ...
                                                    @if($order->invoice_id)
                                                        <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ Storage::url('invoices/invoice_2_20250628_' . $order->invoice_id .'.pdf') }}" class="text-gray-600 text-hover-primary mb-1">{{ $order->invoice_id}}</a>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ Storage::url('receipts/receipt_2_20250628_' . $order->invoice_id .'.pdf') }}" class="text-gray-600 text-hover-primary mb-1">{{ $order->invoice_id}}</a>
                                                                </td>
                                                                <td>
                                                                    @if ($order->total != null)
