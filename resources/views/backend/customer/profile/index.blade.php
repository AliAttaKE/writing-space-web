                                                ...
                                                <tbody class="fs-6 fw-semibold text-gray-600" id="old_package_payment_tbody">
                                                    ...
                                                    @if($order->invoice_id)
                                                        <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ Storage::url('invoice_' . $order->invoice_id .'.pdf') }}" class="text-gray-600 text-hover-primary mb-1">{{ $order->invoice_id}}</a>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ Storage::url('receipt_' . $order->invoice_id .'.pdf') }}" class="text-gray-600 text-hover-primary mb-1">{{ $order->invoice_id}}</a>
                                                                </td>
                                                                <td>
                                                                    @if ($order->total != null)
