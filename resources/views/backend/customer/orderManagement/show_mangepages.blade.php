        ...
        <div class="row justify-content-between h-100 px-3">
            <div class="col-lg-7 mb-3">
                <div class="card p-4 btn-dark-primary">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-4 mb-2 ">
                            <div class="label text-white">Expiration Month*</div>
                        </div>
                        <div class="col-lg-5 mb-2">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-4 mb-2 ">
                            <div class="label text-white">Expiration Year*</div>
                        </div>
                        <div class="col-lg-5 mb-2">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ url()->previous() }}" class="btn btn-dark-primary px-4 text-white">
  Cancel
</a>
            ...
            if (response.status) {
               ...
               var deadline = JSON.parse(localStorage.getItem('deadline'));
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: { 'session': response.session.id ,'order_id':order_id,'total':total,'page':page,'deadline':deadline},
                            dataType: 'json',
                            headers: {
