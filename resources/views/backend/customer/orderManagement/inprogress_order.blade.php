    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 custom-fs-23 fs-color-white">In-Progress Orders</h1>
                <!--end::Title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-gray-900 fw-bold custom-fs-17 fs-color-white">Filter Options</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Separator-->
                                ...
                                <form
                                    ...
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        <div class="mb-3">
                                            <label class="form-label fs-6 fw-semibold custom-fs-13 fs-color-white">Order Id:</label>
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-3">
                                            <label class="form-label fs-6 fw-semibold custom-fs-13 fs-color-white">Topic:</label>
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-3">
                                            <label class="form-label fs-6 fw-semibold custom-fs-13 fs-color-white">Status:</label>
...
<tr>
    ...
    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm badge-custom-bg" id="badge-custom-bg" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
        ...
        <!--begin::Menu-->
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 badge-custom-bg fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="order-details.php" class="menu-link d-flex justify-content-center px-3" id="badge-custom-bg" data-bs-toggle="modal" data-bs-target="#view-invoice_{{$o->id}}">View</a>
            </div>
            {{-- <div class="menu-item px-3">
            ...
            @else
            <div class="menu-item px-3">
                <a class="menu-link d-flex justify-content-center px-3">Revision Exp</a>
            </div>
            @endif --}}
            <!--end::Menu item-->
            <!--begin::Menu item-->
