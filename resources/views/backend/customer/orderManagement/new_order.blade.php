    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 fs-color-white custom-fs-23">New Orders</h1>
                <!--end::Title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-gray-900 fw-bold fs-color-white">Filter Options</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Separator-->
                                ...
                                <form
                                    id="filterForm" 
                                    action="{{ route('customer.new-order') }}" 
                                    method="GET"
                                    ...
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        <div class="mb-3">
                                            <label class="form-label fs-6 fw-semibold fs-color-white">Order Id:</label>
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-3">
                                            <label class="form-label fs-6 fw-semibold fs-color-white">Topic:</label>
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-3">
                                            <label class="form-label fs-6 fw-semibold fs-color-white">Status:</label>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset"
                                                ...
                                                onclick="window.location.href = '{{route('customer.new-order')}}' ">Reset</button>
                                            <button type="submit"
                            ...
                            <!--end::Filter-->
                            <!--begin::Export-->
                            {{-- <button type="button" class="btn btn-light-primary me-3 badge-custom-bg" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users222">
...
<div class="modal fade" id="view-invoice_{{$o->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content badge-custom-bg invoice-pop">
            ...
            <div class="modal-footer border-0 justify-content-between">
                <div class="">
                    <button type="button" class="btn btn-secondary btn-dark-primary" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
