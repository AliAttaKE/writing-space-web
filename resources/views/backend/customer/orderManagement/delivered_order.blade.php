    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-white fw-bold fs-1 flex-column justify-content-center my-0 custom-fs-23 fs-color-white">Delivered Orders</h1>
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url()->previous() }}" class="btn btn-sm fw-bold btn-dark-primary badge-custom-bg">Back</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-custom-bg">
                ...
                <div class="mb-3 d-flex justify-content-center">
                    <h1 class="page-heading d-flex text-white fw-bold fs-1 flex-column justify-content-center my-0">Delivered Orders</h1>
                </div>
                <!--begin::Card header-->
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <!--begin::Filter-->
                            <button type="button" class="btn me-3 badge-custom-bg d-none" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-white fw-bold fs-color-white custom-fs-18">Filter Options</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Separator-->
                                ...
                                <form
                                id="filterForm"
                                action="{{ route('customer.delivered-order') }}"
                                method="GET"
                                ...
                                <div class="px-7 py-5">
                                    <!--begin::Input group-->
                                    <div class="mb-3">
                                        <label class="form-label fs-6 fw-semibold fs-color-white custom-fs-13">Order Id:</label>
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-3">
                                        <label class="form-label fs-6 fw-semibold fs-color-white custom-fs-13">Topic:</label>
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-3">
                                        <label class="form-label fs-6 fw-semibold fs-color-white custom-fs-13">Status:</label>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset"
                                            ...
                                            onclick="window.location.href = '{{route('customer.delivered-order')}}' ">Reset</button>
                                        <button type="submit"
                                            class="btn btn-dark-primary fw-semibold px-6 badge-custom-bg-2">Apply</button>
                                    </div>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Content-->
                            ...
                            data-bs-toggle="modal" data-bs-target="#kt_modal_export_users22"
                            >
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                                ...
                                                                <div class="text-white">Best for business owners and company administrators</div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Radio-->
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                                <div class="fw-bold text-white">Developer</div>
                                                                <div class="text-white">Best for developers or people primarily using the API</div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Radio-->
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_2">
                                                                <div class="fw-bold text-white">Analyst</div>
                                                                <div class="text-white">Best for people who need full access to analytics data, but don't need to update business settings</div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Radio-->
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_3">
                                                                <div class="fw-bold text-white">Support</div>
                                                                <div class="text-white">Best for employees who regularly refund payments and respond to disputes</div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Radio-->
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_4">
                                                                <div class="fw-bold text-white">Trial</div>
                                                                <div class="text-white">Best for people who need to preview content data, but don't need to make any updates</div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Radio-->
...
<tr>
    ...
    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm badge-custom-bg" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
        ...
        <!--begin::Menu-->
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded text-white badge-custom-bg fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="order-details.php" class="menu-link d-flex justify-content-center px-3 badge-custom-bg" id="badge-custom-bg" data-bs-toggle="modal" data-bs-target="#view-invoice_{{$o->id}}">View</a>
            </div>
            ...
            ?>
              ...
              {{-- <div class="menu-item px-3">
                <a class="menu-link d-flex justify-content-center px-3" onclick="RevisionDelete({{$o->id}})">Revision Exp</a>
            </div> --}}
              @endif
            <!--end::Menu item-->
            <!--begin::Menu item-->
                        ...
                        <div class="d-flex flex-column flex-xl-row">
                            ...
                            <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                ...
                                <div class="mt-n1">
                                    ...
                                    <div class="m-0">
                                        <!--begin::Label-->
                                        <div class="fw-bold fs-3 text-white mb-8">Order #{{$o->order_id}}</div>
                                        <!--end::Label-->
                                        <!--begin::Row-->
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Subject:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->subject}}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Col-->
                                            <!--end::Col-->
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Academic level:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->academic_level}}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Col-->
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Type of Paper:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->type_of_paper}}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Col-->
                                            <!--end::Col-->
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Paper Format:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->paper_format}}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Language and Spelling:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->language_spelling}}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Col-->
                                            <!--end::Col-->
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Number of pages:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->number_of_pages}}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Col-->
                                            {{-- <div class="col-md-3"> --}}
                                            ...
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Power Point Slides:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->powerpoint_slide}}</div>
                                                <!--end::Text-->

                                            </div>
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">No# Extra Sources:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->no_of_extra_sources}}</div>
                                                <!--end::Text-->
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white"> {{ \Carbon\Carbon::parse($o->created_at)->format('d F Y h:iA')  }}</div>
                                                <!--end::Text-->
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{ \Carbon\Carbon::parse($o->deadline)->format('d F Y h:iA') }}</div>
                                                <!--end::Text-->
                                            ...
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Order Type:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->order_type}}</div>
                                                <!--end::Text-->

                                            </div>
                                            <div class="col-md-3">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-white mb-1">Order Status:</div>
                                                <!--end::Label-->
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-white">{{$o->order_status}}</div>
                                                <!--end::Text-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="col-md-12">
                                                    <!--end::Label-->
                                                    <div class="fw-semibold fs-7 text-white mb-1">Revision Request:</div>


                                                    <form  action="{{ route('customer.revision.submit') }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                        <input type="hidden" value="{{$o->order_id}}" name="order_id">


                                                    <textarea class="btn-dark-primary" name="revision_request" id="" cols="70" rows="10"></textarea>

                                                    <button type="submit" class="btn btn-dark-primary"> Request for revision</button>
                                                    </form>
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = '{{ route("customer.deleteOrder", ["id" => ":id"]) }}';
url = url.replace(':id', id);
    ...
    function RevisionDelete(id) {
        ...
        Swal.fire({
            ...
            confirmButtonColor: '#d33',
            cancelButtonColor: '#3085d6',
            confirmButtonText: 'Yes, Revision date update request!'
        }).then((result) => {
            if (result.isConfirmed) {

                var url = '{{ route("customer.revision.exp", ["id" => ":id"]) }}';
url = url.replace(':id', id);
        ...
        _token: '{{ csrf_token() }}'
                ...
                Swal.fire('Deleted!', 'Your Revision Date Request.', 'success');
            }
        });
    }
</script>
