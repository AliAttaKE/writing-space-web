                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg"
                                    ...
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                        <div class="fs-5 text-gray-900 fw-bold fs-color-white custom-fs-23">Filter
                                            Options</div>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Separator-->
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Content-->
                                    <form id="filterForm" action="{{ route('admin.other-order') }}" method="GET"
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-3">
                                                <label
                                                    class="form-label fs-6 fw-semibold fs-color-white custom-fs-17">Order
                                                    Id:</label>
                                            ...
                                            <div class="mb-3">
                                                <label
                                                    class="form-label fs-6 fw-semibold fs-color-white custom-fs-17">Topic:</label>
                                            ...
                                            <div class="mb-3">
                                                <label
                                                    class="form-label fs-6 fw-semibold fs-color-white custom-fs-17">Status:</label>
                                                <input type="text" placeholder="Status" name="order_status" id="field_3"
                                                    value="{{ Request::get('order_status') }}" autocomplete="off"
                                                    class="form-control btn-dark-primary" />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Actions-->
                                            <div class="d-flex justify-content-end">
                                                <button type="reset" class="btn btn-dark-primary fw-semibold me-2 px-6"
                                                    onclick="window.location.href = '{{route('admin.other-order')}}' ">Reset</button>
                                                <button type="submit"
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                            id="kt_table_new_orders">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    {{-- <th class="w-10px pe-2 pb-8">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                data-kt-check-target="#kt_table_new_orders .form-check-input"
                                                value="1" />
                                        </div>
                                    </th> --}}
                            ...
                            <tbody class="text-gray-600 fw-semibold text-color">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span
                                            class="badge badge-light-success fw-bold me-auto px-4 py-3 badge-custom-bg">{{$o->order_show}}</span>
                                        @else
                                        <span
                                            class="badge badge-light-danger fw-bold me-auto px-4 py-3">{{$o->order_show}}</span>
                                        @endif
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 badge-custom-bg"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <li><a href="#"
                                                        ...
                                                        data-bs-target="#view-invoice_{{$o->id}}">View</a></li>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <!--<div class="menu-item px-3">-->
                                                <!--    <a class="menu-link d-flex justify-content-center px-3" onclick="confirmDelete({{$o->id}})">Delete</a>-->
                                                <!--</div>-->
                                                <!--                                            <li><a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}}, 'Pending')">New</a></li>-->
                                                <!--<li><a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'In-Progress')">In-Progress</a></li>-->
                                                <!-- <li><a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Completed')">Completed</a></li>-->
                                                <!--  <li><a class="menu-link d-flex justify-content-center px-3 text-white" onclick="delivered({{$o->id}},'Delivered')">Delivered</a></li>-->
                                                                        ...
                                                                        <div class="row g-5 mb-12">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <div
                                                                                    class="fw-bold fs-color-white custom-fs-13">
                                                                                    {{
                                                                                    \Carbon\Carbon::parse($o->created_at)->format('Y/m/d
                                                                                    h:iA') }}</div>
                                                                                <!--end::Text-->
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <div
                                                                                    class="fw-bold fs-color-white custom-fs-13">
                                                                                    {{
                                                                                    \Carbon\Carbon::parse($o->deadline)->format('Y/m/d
                                                                                    h:iA') }}</div>
                                                                                <!--end::Text-->
                                ...
                                <tr>
                                    ...
                                    <td><a href="#"
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 badge-custom-bg"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#"
                                                    class="menu-link d-flex justify-content-center px-3 text-white text-white"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#view-invoice-canceled_{{$o->id}}">View</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <!--                                                <div class="menu-item px-3">-->
