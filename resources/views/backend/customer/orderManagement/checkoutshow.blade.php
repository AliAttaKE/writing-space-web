...
<script src="{{ env('PAYMENT_GATEWAY_URL') }}/form/version/{{ env('API_VERSION', 74) }}/merchant/{{ env('MERCHANT_ID') }}/session.js"></script>
                    ...
                    <div class="card p-4 mb-4 btn-dark-primary">
                        ...
                        <div class="card-bod total-amt py-3 px-2 rounded-3 bg-transparent">
                            ...
                            <ul class="d-flex d-flex list-unstyled justify-content-between">
                                ...
                                <li class="text-white">$ <span id="subject" class="text-white"></span></li>
                            </ul>
                            <ul class="d-flex d-flex list-unstyled justify-content-between">
                    ...
                    formSessionUpdate: function (response) {
                        ...
                        if (response.status) {
                            if ("ok" == response.status) {
                                ...
                                $.ajax({
                                    url: '{{ route("customer.payment.store.free") }}',
                                    type: 'POST',
