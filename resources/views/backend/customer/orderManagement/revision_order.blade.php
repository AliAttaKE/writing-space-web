    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-1 flex-column justify-content-center my-0 fs-color-white custom-fs-23">Revision Orders</h1>
                <!--end::Title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px badge-custom-bg" data-kt-menu="true">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-gray-900 fw-bold custom-fs-18 fs-color-white">Filter Options</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Separator-->
                                ...
                                <form
                                    id="filterForm"
                                    action="{{ route('customer.revision-order') }}"
                                    method="GET"
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset"
                                                ...
                                                onclick="window.location.href = '{{route('customer.revision-order')}}' ">Reset</button>
                                            <button type="submit"
...
<tr>
    ...
    <td><a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm badge-custom-bg " id="badge-custom-bg " data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
            ...
            <!--begin::Menu item-->
            <!--<div class="menu-item px-3">-->
            <!--    <a class="menu-link d-flex justify-content-center px-3 badge-custom-bg " id="badge-custom-bg " onclick="confirmDelete({{$o->id}})">Delete</a>-->
            <!--</div>-->
            <!--end::Menu item-->
            <!--begin::Menu item-->
            {{-- <div class="menu-item px-3">
                <a href="/images/myw3schoolsimage.jpg" class="menu-link d-flex justify-content-center px-3 badge-custom-bg " id="badge-custom-bg " download>Download</a>
            </div> --}}
            <!--end::Menu item-->
        </div>
    </td>
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            ?>
                                                ...
                                                <div class="fw-bold fs-6 text-gray-800">
                                                    {!! $revisionSubmit->revision_request ?? 'Revision request not available' !!}
                                                </div>
