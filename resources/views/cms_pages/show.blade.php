...
<section class="bg-dark section-card-phases">
    <div class="heartbeat-heading d-flex justify-content-between align-items-center key-journey">
        ...
        <div class="text-container flex-grow-1 text-center position-relative">
            <h1 class="heading heading-custom-3">{{ $cmsPage->title }}</h1>
        </div>
    ...
    <div class="container-lg px-4 plagiarism-custom-2">
        <section class="row my-card mt-3 bordered-card">
            <div class="col-md-8">
                @if($cmsPage->heading_one || $cmsPage->heading_two)
                <div class="heading-container">
                    <h2 class="heading-val head-head">{{ $cmsPage->heading_one }}<br> <span
                            class="subhead-subhead yellow-text">{{ $cmsPage->heading_two }}</span></h2>
                </div>
                @endif
                @if($cmsPage->heading_two || $cmsPage->content_two)
                <p class="custom-description text-white">{{ $cmsPage->content_one }}</p>
            ...
            <div class="col-md-8 pt-5">
                @if($cmsPage->heading_three || $cmsPage->heading_three)
                <div class="heading-container">
                    <h2 class="heading-val head-head">{{ $cmsPage->heading_four }}<br> <span
                            class="subhead-subhead yellow-text">{{ $cmsPage->heading_four }}</span></h2>
                </div>
                @endif
                @if($cmsPage->heading_four || $cmsPage->content_four)
                <p class="custom-description text-white">{{ $cmsPage->content_three }}</p>
                @endif
            </div>
