            ...
            <!--begin:Menu link--><a href="menu-link" class=""> <span class="menu-link"><span
                ...
                <div class="app-navbar flex-shrink-0">
                    ...
                    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color badge-custom-bg fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <a href="{{ route('admin.show.profile') }}" class="fw-semibold fs-color-white custom-fs-13 fs-7">
                                            {{ Auth::user()->email }} </a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{ route('admin.show.profile') }}" class="menu-link px-5 fs-color-white custom-fs-13">
                                    My Profile
                                </a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{route('admin.completed-order')}}" class="menu-link px-5 fs-color-white custom-fs-13">
                                    Completed Orders
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{route('admin.message-management')}}" class="menu-link px-5 fs-color-white custom-fs-13">
                                    Messages
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{route('admin.folder.show')}}" class="menu-link px-5 fs-color-white custom-fs-13">
                                    Files
                                </a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-5">
                                {{-- <form action="{{ route('admin.logout') }}" method="post">
                                    @csrf
                                    <a href="#" onclick="event.preventDefault(); this.closest('form').submit();" class="menu-link px-5 fs-color-white custom-fs-13">
                                        Log out
                                    </a>
                                </form> --}}
                                ...
                                <form action="{{ route('admin.logout') }}" method="post">
                                    @csrf
                                    <button type="submit" class="menu-link px-5 fs-color-white custom-fs-13">
                                        Log out
                                    </button>
                                </form>
