 ...
 @php
    ...
    $InProgressCount = $orderCount['In-Progress'] ?? 0;
...
@endphp
    ...
    <body id="kt_app_body " data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
        ...
        data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default" style=" background-image: url({{ asset('backend/assets/media/ws/customer-dashboard.jpg') }});">
        <!--begin::Header-->
        <div id="kt_app_header" class="app-header customer-header-custom" data-kt-sticky="true"
            data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize"
            data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false">
            <!--begin::Header container-->
            <div class="app-container bg-nav-cus-dark container-fluid d-flex align-items-stretch justify-content-between py-5"
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="#" onclick="window.location.href='{{route('customer.dashboard')}}' " class="d-lg-none">
                        <img alt="Logo" src="{{ asset('backend/assets/media/ws/ws-light-logo.png') }}" class="h-30px" />
                    </a>
                </div>
                <!--end::Mobile logo-->
                        ...
                        @auth
                            ...
                            <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-35px"
                                    ...
                                    @if (Auth::user()->avatar)
                                        <img src="{{ asset('images/users/customers/' . Auth::user()->avatar) }}" />
                                    @else
                                        <img src="{{ asset('backend/assets/media/ws/profile.png') }}" alt="image" />
                                    @endif
                                </div>
                                <!--begin::User account menu-->
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg badge-custom-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    data-kt-menu="true">
                                    <!--begin::Menu item-->
                                        ...
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                @if (Auth::user()->avatar)
                                                    <img src="{{ asset('images/users/customers/' . Auth::user()->avatar) }}" />
                                                @else
                                                    <img src="{{ asset('backend/assets/media/ws/profile.png') }}"
                                                        alt="image" />
                                                @endif
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ url('/') }}" class="menu-link fs-color-white custom-fs-13 px-5">
                                            Home Page
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="{{ route('customer.show.profile') }}" class="menu-link fs-color-white custom-fs-13 px-5">
                                            My Profile
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
            ...
            <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
                ...
                <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        <div id="kt_app_sidebar" class="app-sidebar  flex-column customer-siderbar" data-kt-drawer="true"
                                    ...
                                    <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                                        ...
                                        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                                            ...
                                            <div class="menu-item menu-accordion"><!--begin:Menu link--><span
                                                    class="menu-link py-0"><span class="menu-icon"><i
                                                            class="ki-duotone ki-element-11 fs-2"><span
                                                                class="path1"></span><span class="path2"></span><span
                                                                class="path3"></span><span
                                                                class="path4"></span></i></span><span class="menu-title"><a
                                                            class="menu-link custom-menu ps-0 {{ (request()->is('customer/dashboard')) ? 'active' : '' }}"
                                        ...
                                        <div class="menu-item menu-accordion "><!--begin:Menu link--><span
                                                class="menu-link py-0"><span class="menu-icon"><i
                                                    ...
                                                    </span></span><!--end:Menu link-->
                                        </div><!--end:Menu item-->
                                        <!--begin:Menu item-->
                                        <div data-kt-menu-trigger="click"
                                        class="menu-item menu-accordion <?= $page == 'create-order.php' || $page == 'new-order.php' || $page == 'in-progress-order.php' || $page == 'completed-order.php' || $page == 'revision-orders.php' || $page == 'completed-order.php' ? 'active' : '' ?>">
                                        <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><i
                                                    class="ki-duotone ki-purchase fs-2"><span
                                                        class="path1"></span><span
                                                        class="path2"></span></i></span><span
                                                class="menu-title custom-menu">Order Management</span><span
                                                class="menu-arrow"></span></span><!--end:Menu link--><!--begin:Menu sub-->
<div class="menu-sub menu-sub-accordion">
    <!-- Place New Orders -->
    <div class="menu-item">
        <a class="menu-link {{ $page == 'create-order.php' ? 'active' : '' }}" href="{{ route('customer.customerPlaceOrder') }}">
            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
            <span class="menu-title custom-menu">Place New Orders</span>
        </a>
    </div>
    ...
    <a class="menu-link ps-0 custom-menu {{ request()->routeIs('file_chat_gpts.approved') ? 'active' : '' }}"
        ...
        <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
        <span class="menu-title custom-menu">Complete Order</span>
    </a>
</div>
                                            ...
                                            <div class="menu-item menu-accordion "><!--begin:Menu link--><span
                                                    class="menu-link py-0"><span class="menu-icon"><i
                                                            class="ki-duotone ki-switch fs-2"><span
                                                                class="path1"></span><span
                                            ...
                                            <div class="menu-item menu-accordion "><!--begin:Menu link--><span
                                                    class="menu-link py-0"><span class="menu-icon"><i
                                                            class="ki-duotone ki-profile-circle fs-2"><span
                                                                class="path1"></span><span class="path2"></span><span
                                                                class="path3"></span></i></span><span class="menu-title"><a
                                                            class="menu-link ps-0 custom-menu {{ (request()->is('customer/show/profile')) ? 'active' : '' }}"
                                                            href="{{ route('customer.show.profile') }}">Your
                            ...
                            <div id="kt_activities_scroll" class="position-relative scroll-y me-n5 pe-5"
                                ...
                                <div class="timeline timeline-border-dashed">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <!--begin::Timeline icon-->
                                        <div class="timeline-icon">
                                            <i class="ki-duotone ki-pencil fs-2 text-gray-500"><span
                                                    class="path1"></span><span class="path2"></span></i>
                                        </div>
                                        <!--end::Timeline icon-->
                                        <!--begin::Timeline content-->
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <!--begin::Timeline icon-->
                                        <div class="timeline-icon">
                                            <i class="ki-duotone ki-basket fs-2 text-gray-500"><span
                                                    class="path1"></span><span class="path2"></span><span
                                                    class="path3"></span><span class="path4"></span></i>
                                        </div>
                                        <!--end::Timeline icon-->
    ...
    <script>
        ...
        form.onsubmit = function() {
            ...
            var quillContent = quill.root.innerHTML;
            // Update the hidden textarea with HTML content
            form.querySelector('textarea[name=order-message]').value = quillContent;
        };
    </script>
