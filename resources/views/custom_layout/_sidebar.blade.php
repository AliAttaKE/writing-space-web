 ...
 @php
    ...
    @endphp
                ...
                <div class="menu-item"><!--begin:Menu link--><a class="menu-link " href="{{route('admin.orders_history')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Order Log</span> <span class="badge"></span></a><!--end:Menu link-->
                 ...
                 <div class="menu-item"><!--begin:Menu link--><a class="menu-link " href="{{route('admin.orders_free')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Post-Delivery Payment Status</span> <span class="badge"></span></a><!--end:Menu link-->
                </div>
            </div><!--end:Menu sub-->
        </div><!--end:Menu item-->
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion ">
            ...
            <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                ...
                <div class="menu-item"><!--begin:Menu link--><a class="menu-link " href="{{route('admin.custom-setting')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Custom
                            Order web</span></a><!--end:Menu link--></div><!--end:Menu item-->
                <div class="menu-item"><!--begin:Menu link--><a class="menu-link " href="{{route('admin.custom-setting-package')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Custom
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion ">
            ...
            <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                ...
                <div class="menu-item"><!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/show/customers/referral')) ? 'active' : '' }}" href="{{ route('admin.show.customers.referral') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Customer Referral 
                            Table</span>
                    </a><!--end:Menu link-->
                </div><!--end:Menu item--><!--end:Menu item-->
            </div><!--end:Menu sub-->
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion"><!--begin:Menu link--><span class="menu-link "><span class="menu-icon"><i class="ki-duotone ki-abstract-28 fs-2"><span class="path1"></span><span class="path2"></span></i></span><span class="menu-title custom-menu">Services</span><span class="menu-arrow"></span></span><!--end:Menu link--><!--begin:Menu sub-->
            <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                <!--begin:Menu item-->
                      ...
                      <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="{{ route('admin.customer_orders.index') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Assign Pay-Later Order Limit</span></a><!--end:Menu link--></div><!--end:Menu item-->
                ...
                <div class="menu-item "><!--begin:Menu link--><a class="menu-link " href="{{ route('admin.coupons.index') }}" ><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Coupons</span></a><!--end:Menu link--></div><!--end:Menu item-->
                 ...
                 <div class="menu-item "><!--begin:Menu link--><a class="menu-link " href="{{ route('admin.revisions.index') }}" ><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title custom-menu">Revisions</span></a><!--end:Menu link--></div><!--end:Menu item-->
