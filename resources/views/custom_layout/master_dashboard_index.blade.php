...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default" style=" background-image: url({{ asset('backend/assets/media/ws/customer-dashboard.jpg') }});">
    <!--begin::Header-->
                ...
                <div class="app-navbar flex-shrink-0">
                    ...
                    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            @if (Auth::user()->avatar)
                            <img src="{{asset('images/users/admins/'. Auth::user()->avatar)}}"  />
                            @else
                                <img src="{{ asset('backend/assets/media/avatars/300-6.jpg') }}" alt="image" />
                            @endif

                            {{-- <img src="{{ asset('backend/assets/media/avatars/300-3.jpg') }}" class="rounded-3" alt="user" /> --}}
                        </div>
                        <!--begin::User account menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px badge-custom-bg" data-kt-menu="true">
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <a href="{{ route('admin.show.profile') }}" class="fw-semibold text-muted  fs-7">
                                            {{ Auth::user()->email }} </a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            ...
                            <!--begin::Menu item-->
                             <div class="menu-item px-5">
                                <a href="{{ url('/') }}" class="menu-link px-5 text-white">
                                    Home Page
                                </a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{route('admin.message-management')}}" class="menu-link px-5 text-white">
                                    Messages
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{route('admin.folder.show')}}" class="menu-link px-5 text-white">
                                    Files
                                </a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-5">
                                <form action="{{ route('admin.logout') }}" method="post">
                                    @csrf
                                    <a href="#" onclick="event.preventDefault(); this.closest('form').submit();" class="menu-link px-5 text-white">
                                        Log out
                                    </a>
                                </form>
            ...
            <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                ...
                <div id="kt_app_sidebar" class="app-sidebar  flex-column " data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        <!--begin::Logo image-->
                        <a href="?page=index">
                            <img alt="Logo" src="{{ asset('backend/assets/media/ws/ws-light-logo.png') }}" class="h-50px app-sidebar-logo-default" />
                            <img alt="Logo" src="{{ asset('backend/assets/media/ws/ws-light-logo.png') }}" class="h-35px app-sidebar-logo-minimize" />
                        </a>
                        <!--end::Logo image-->
        ...
        -->
                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
                            ...
                            @include('custom_layout._sidebar')
                            <!--end::Scroll wrapper-->
                        </div>
                        <!--end::Menu wrapper-->
                    </div>
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                        <!--begin::Title-->
                                        <a href="?page=apps/projects/project" class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Meeting
                                            with customer</a>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                        <!--begin::Title-->
                                        <a href="?page=apps/projects/project" class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Project
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                                <a href="?page=apps/projects/project" class="fs-6 text-hover-primary fw-bold">Finance KPI App
                                                    Guidelines</a>
                                                <!--end::Desc-->
                                                <!--begin::Number-->
    ...
    <!--end::Activities drawer--><!--begin::Chat drawer-->
    ...
    <!--end::Chat drawer--><!--begin::Chat drawer-->
