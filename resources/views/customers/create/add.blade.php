...
{{--                                    <option value="{{$record->erp_subject_name}}">{{$record->erp_subject_name}}</option>--}}
{{--                                @endforeach--}}
                            ...
                            <div class="mt-4 dc" id="">
                                <input  class="other_input" type="text" name="erp_sub"    placeholder="Add course">
                            </div>
                        ...
                        <div class="form-line">
                            <select class="form-control select2" name="erp_order_topic" id="Quiz-type" data-placeholder="Select">
                                <option value="other">I’ll Write the Topic</option>
                                <option value="hhhh">Let the Writer Choose</option>
                                <option value="ttttt">Same as Subject/Discipline Chosen Above</option>
                            </select>
                            <div class="mt-3 dc">
                                <input  type="text" name="erp_order_text" class="form-control other_input" id="">
                            </div>
                        </div>
                        <br>
                        ...
                        <div>
                            ...
                            <input type="text" name="erp_order_message"  class="ckeditor form-control" id="comment_text" cols="30" rows="10">
                        ...
                        <div class="form-line">
                            <select class="form-control select2" name="erp_academic_name" id="Quiz-type" data-placeholder="Select">
{{--                                @foreach($academic_level as $record)--}}
{{--                                    <option value="{{$record->erp_academic_name}}">{{$record->erp_academic_name}}</option>--}}
{{--                                @endforeach--}}
                                <option value="other">Other (not listed above)</option>
                            </select>
                            <div class="mt-4 dc" id="">
                                <input type="text" name="erp_academic_description" class="other_input"  placeholder="Description Here">
                            </div>
                            <br>
...
{{--                                    <option value="{{$record->erp_paper_type}}">{{$record->erp_paper_type}}</option>--}}
{{--                                @endforeach--}}
                                <option value="other">Other (not listed above)</option>
                            </select>
                            <div class="mt-4 dc" id="">
                                <input type="text" name="erp_paper_description" class="other_input"  placeholder="Description Here">
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="form-line">
                            <select class="form-control select2" name="erp_paper_format" id="Quiz-type" data-placeholder="Select">
{{--                                @foreach($paper_format as $record)--}}
{{--                                    <option value="{{$record->erp_paper_format}}">{{$record->erp_paper_format}}</option>--}}
{{--                                @endforeach--}}
                                <option value="other">Other (not listed above)</option>
                            </select>
                            <div class="mt-4 dc" id="">
                                <input type="text" name="erp_format_description" class="other_input"  placeholder="Description Here">
                            </div>
                        ...
                        <div class="form-line">
                            <select class="form-control select2" name="erp_language_name" id="Quiz-type" data-placeholder="Select">
{{--                                @foreach($language_style as $record)--}}
{{--                                    <option value="{{$record->erp_language_name}}">{{$record->erp_language_name}}</option>--}}
{{--                                @endforeach--}}
                            </select>
                            <br>
...
{{--                                    <option value="{{$record->id}}">{{$record->erp_team_name}}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
                            <br>
                        </div>
                        ...
                        <div class="form-line">
                            <select class="form-control select2 " id="" name="erp_resource_materials" data-placeholder="Select">
                            ...
                            <div class="mt-4 bc file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" name="erp_resource_file" type="text">
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-line">
                            <input type="number" name="erp_number_Pages" min="0" class="form-control" id="">
                        ...
                        <div class="form-line">
                            <select class="form-control select2" name="erp_spacing" id="Quiz-type" data-placeholder="Select">
                                ...
                                <option value="1">Double Spacing</option>
                            </select>
                        ...
                        <div class="form-line">
                            <input type="number" min="0" name="erp_powerPoint_slides" class="form-control" id="">
                        ...
                        <div class="form-line">
                            <input type="number" min="0" name="erp_extra_source" class="form-control" id="">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                    class="btn btn-info waves-effect">Place Order</button>
                        </div>
                    </form>
                </div>
            </div>
