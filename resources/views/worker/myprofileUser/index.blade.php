                ...
                <div class="card body">
                    ...
                    <div class="row">
                        <div class="contact-photo">
                            <a href="{{url('myprofile-user')}}" style="width:80px;" >
                    ...
                    <div class="contact-usertitle">
                        ...
                        <div class="contact-usertitle-job"> {{auth()->user()->user_type}} </div>
                    </div>
...
{{--                    </ul>--}}
                    ...
                    <div class="newLabelBtn">
                        <button type="button" class="btn btn-border-radius bg-success waves-effect">
                           User Status: Active
                        </button>
                    </div>
                    ...
                    @else
                        <div class="newLabelBtn">
                            <button type="button" class="btn btn-border-radius bg-danger waves-effect">
                    ...
                    <div class="col-md-12 col-8">
                        ...
                        <div class="tab-content" id="myTabContent" style="padding: 20px 30px";>
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row ">
                                    <div class="col-sm-12">
                                        <label> {{ Auth::user()->erp_image == null ? 'Add Profile Image' : 'Edit Profile Image' }} </label>
...
{{--                                                                                            data-dismiss="modal" data-dismiss="modal">Update</button>--}}
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form method="POST" id="home" action="{{url('security-user',auth()->user()->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
