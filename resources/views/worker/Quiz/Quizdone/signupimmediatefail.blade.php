...
{{--                            <p class="font-12"> Lorem ispum is a dummy text for absoulute beginners and advanced programmers</p>--}}
                            @if($quiz != null)
                                <h3 class="mt-5">Sorry Better Luck Next Time You're failed a previous quiz please click below to take a next quiz to complete your registration </h3>
                                <a class="btn btn-primary  mt-3" href="{{url('user-dashboard')}}" >
                                    NEXT QUIZ
                                </a>
                            @else
                                <h3 class="mt-5">Sorry Better Luck Next please waiting for your account approval</h3>
                            @endif
                        </div>
                    </div>
