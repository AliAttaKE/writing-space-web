...
@php
    $quiz = DB::table('registrationquizzes')->where(['quiz_type'=>'signup','user_id'=>Auth()->user()->id,'quiz_is_passed'=>1])->orderBy('quiz_reorder', 'ASC')->get()->first();
                ...
                <div class="row mt-2 align-items-center py-5">
                    ...
                    <div class="col-12 text-center">
                        ...
                        @if($quiz != null)
                            ...
                            <h3 class="mt-5"> please waiting for your account approval </h3>

                        @else
                            <i class="far fa-frown  fa-10x"></i>
                            <h3 class="mt-5">Fail Better Luck Next please waiting for your account approval</h3>
                        @endif
                    </div>
                </div>
