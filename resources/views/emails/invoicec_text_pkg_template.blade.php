...
<head>
    ...
    <title>Welcome to Your New Writing Space Package</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <ul>
            <li><strong>Package Type:</strong> {{ $invoiceData['itemName'] }}</li>
            <li><strong>Purchase Date:</strong> {{ $invoiceData['dateOfIssue'] }}</li>
            <li><strong>Total:</strong> ${{ $invoiceData['subTotal'] }}</li>
            <li><strong>Total Pages:</strong> {{ $invoiceData['totalPages'] }}</li>
        </ul>
