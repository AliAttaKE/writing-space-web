...
var KTChartsWidget18 = function () {
    ...
    var initChart = function(chart) {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));
        var labelColor = KTUtil.getCssVariableValue('--bs-light-light');
        var borderColor = KTUtil.getCssVariableValue('--bs-border-dashed-color');    
        ...
        var options = {
            ...
            xaxis: {
                categories: ['Prospects', 'Tier 1', 'Tier 2', 'Tier 3', 'Tier 4'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
                ...
                labels: {
                    style: {
                        colors: KTUtil.getCssVariableValue('--bs-light-light'),
                        fontSize: '13px'
                    }                  
                },
                crosshairs: {
...
var KTChartsWidget3 = function () {
    ...
    var initChart = function(chart) {
        ...
        var borderColor = KTUtil.getCssVariableValue('--bs-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--bs-danger');
        var base_2Color = KTUtil.getCssVariableValue('--bs-info');
        var base_3Color = KTUtil.getCssVariableValue('--bs-success');
        var base_4Color = KTUtil.getCssVariableValue('--bs-warning');
        var lightColor = KTUtil.getCssVariableValue('--bs-danger');
        var light_2Color = KTUtil.getCssVariableValue('--bs-info');
        var light_3Color = KTUtil.getCssVariableValue('--bs-success');
        var light_4Color = KTUtil.getCssVariableValue('--bs-warning');
        ...
        var options = {
            series: [{
                ...
                name: 'In Progress',
                data: [18, 18, 20, 36, 63, 19, 30, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22]
            },{
                name: 'Revision',
                data: [18, 18, 59, 13, 95, 62, 93, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22]
            },{
                name: 'Delivered',
                data: [18, 18, 98, 47, 3, 92, 47, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22]
            }],            
            chart: {
                fontFamily: 'inherit',
                type: 'area',
            ...
            stroke: {
                ...
                show: true,
                width: 3,
                colors: [baseColor,base_2Color,base_3Color,base_4Color]
            },
            xaxis: {
                categories: ['Apr 01', 'Apr 02', 'Apr 03', 'Apr 04', 'Apr 05', 'Apr 06', 'Apr 07', 'Apr 08', 'Apr 09', 'Apr 10', 'Apr 11', 'Apr 12', 'Apr 13', 'Apr 14', 'Apr 15', 'Apr 16', 'Apr 17', 'Apr 18', 'Apr 19', 'Apr 20', 'Apr 21', 'Apr 22', 'Apr 23', 'Apr 24', 'Apr 25', 'Apr 26', 'Apr 27','Apr 28', 'Apr 29', 'Apr 30', ''],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
            ...
            colors: [lightColor,light_2Color,light_3Color,light_4Color],
            grid: {
                borderColor: borderColor,
                strokeDashArray: 4,
                yaxis: {
